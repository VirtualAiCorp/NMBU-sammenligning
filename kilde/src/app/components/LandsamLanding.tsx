import { TrendingUp, BookOpen, Globe2, Star, GraduationCap, Users, Microscope } from 'lucide-react';
...
export function LandsamLanding({ faculty, onOpenAnalysis, onOpenCourses, onOpenMarketStatus, onOpenStudiebarometer, onOpenCompletion, onOpenStudents, onOpenStaff, onBackToFaculties }: Props) {
