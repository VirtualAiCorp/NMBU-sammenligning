import { TrendingUp, BookOpen, Globe2, Star, GraduationCap, Users, Microscope, Home, Landmark, Coins, Baby, Briefcase } from 'lucide-react';
          ...
          >
            <div className="flex items-start gap-5">
              ...
              <div>
                <div className="flex items-center gap-3 mb-1">
                  <div style={{ fontFamily: "'Lora', serif", fontWeight: 500, fontSize: '20px', color: 'var(--nmbu-green-dark)' }}>
                    Arbeidsmarkedet etter utdanning
                  </div>
                  <div className="text-xs px-2 py-0.5 rounded-full font-medium" style={{ backgroundColor: '#D1FAE5', color: '#047857' }}>
                    SSB og utdanning.no
                  </div>
                ...
                <p style={{ fontSize: '13px', color: 'var(--nmbu-neutral-2)', lineHeight: 1.6, maxWidth: 580 }}>
                  Lønn 0–2 og 3–4 år etter fullført grad, ledighet og de vanligste yrkene for fagfeltene programmene
                  utdanner til. Tallene er nasjonale per fagfelt, ikke per institusjon.
                </p>
              </div>
            </div>
          </button>
