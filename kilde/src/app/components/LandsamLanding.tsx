import { TrendingUp, BookOpen, Globe2, Star, GraduationCap, Users, Microscope, Home } from 'lucide-react';
...
export function LandsamLanding({ faculty, onOpenAnalysis, onOpenCourses, onOpenMarketStatus, onOpenStudiebarometer, onOpenCompletion, onOpenStudents, onOpenStaff, onOpenHousing, onBackToFaculties }: Props) {
