...
import { BookOpen, Building2, Trees, Atom, Leaf, FlaskConical, TreePine, Lock, PawPrint, Users, Home } from 'lucide-react';
import { FACULTIES, FACULTY_IDS, type FacultyId } from '../data/faculties';

export type Faculty = 'hh' | FacultyId | 'nmbu-emner' | 'nmbu-fagmiljo' | 'nmbu-bolig';
      ...
      <div className="max-w-3xl w-full">
        ...
        >
          <div className="w-11 h-11 rounded-xl flex items-center justify-center shrink-0" style={{ backgroundColor: 'var(--nmbu-green-4)' }}>
            <BookOpen className="w-5 h-5" style={{ color: 'var(--nmbu-green-dark)' }} />
          </div>
          <div>
        ...
        >
          <div className="w-11 h-11 rounded-xl flex items-center justify-center shrink-0" style={{ backgroundColor: 'var(--nmbu-green-4)' }}>
            <Home className="w-5 h-5" style={{ color: 'var(--nmbu-green-dark)' }} />
          </div>
          <div>
            <div style={{ fontFamily: "'Lora', serif", fontWeight: 500, fontSize: '20px', color: 'var(--nmbu-green-dark)', marginBottom: 4 }}>Bolig og studentboliger</div>
            <p style={{ fontSize: '13px', color: 'var(--nmbu-neutral-2)', lineHeight: 1.5 }}>
              Dekningsgrad for studentboliger, kvadratmeterpriser og leiepriser i Ås og ved konkurrentenes studiesteder, med nabokommuner rundt studiestedet. NSO 2026 og SSB.
            </p>
          </div>
        </button>
