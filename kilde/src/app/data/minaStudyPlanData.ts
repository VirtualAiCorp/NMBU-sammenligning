// GENERERT av scripts/build-mina-studyplans.py – stub. Ikke rediger for hånd.
// Tom foreløpig: generatoren skriver over hele filen når studieplanene for MINA er lagt inn.
