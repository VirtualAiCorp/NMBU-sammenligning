    ...
    entries: [
      {
        ...
        years: {
          ...
          '2021': { ...Y(678, 112, 50, 63.4, 575, 70, 52.9, 54.3), op_mott: 56.5, kp_mott: 49.6, op_fv: 53.5, op_alle: 54.2, n_mott: 40 },
          '2022': { ...Y(522, 76, 50, 69.7, 457, 74, 49.7, 51.0), op_mott: 56.1, kp_mott: 48.6, op_fv: 54.8, op_alle: 55.9, n_mott: 36 },
          '2023': { ...Y(580, 84, 50, 71.4, 503, 88, 48.3, 46.9), op_mott: 55.8, kp_mott: 48.6, op_fv: 53.3, op_alle: 54.7, n_mott: 32 },
          '2024': { ...Y(566, 85, 50, 72.9, 478, 100, 41.9, 42.8), op_mott: 54.0, kp_mott: 46.5, op_fv: 54.6, op_alle: 54.1, n_mott: 55 },
          '2025': { ...Y(583, 85, 60, 69.4, 495, 91, 0, 0), op_mott: 52.5, kp_mott: 45.5, op_fv: 53.6, op_alle: 53.8, n_mott: 46 },
      ...
      },
      {
        ...
        years: {
          ...
          '2021': { ...Y(887, 124, 99, 56.5, 740, 190, 42.3, 41.7), op_mott: 49.9, kp_mott: 42.2, op_fv: 50.2, op_alle: 51.7, n_mott: 87 },
          '2022': { ...Y(818, 128, 99, 73.4, 675, 179, 0, 0), op_mott: 50.5, kp_mott: 43.4, op_fv: 51.3, op_alle: 53.0, n_mott: 73 },
          '2023': { ...Y(751, 131, 99, 66.4, 622, 167, 0, 0), op_mott: 50.3, kp_mott: 43.1, op_fv: 51.1, op_alle: 52.9, n_mott: 84 },
          '2024': { ...Y(716, 127, 99, 60.6, 586, 158, 0, 0), op_mott: 50.5, kp_mott: 43.4, op_fv: 52.7, op_alle: 52.9, n_mott: 82 },
          '2025': { ...Y(689, 131, 99, 60.3, 551, 129, 0, 0), op_mott: 52.9, kp_mott: 44.9, op_fv: 52.6, op_alle: 53.2, n_mott: 74 },
      ...
      },
      {
        ...
        years: {
          ...
          '2021': { ...Y(1005, 180, 85, 71.1, 906, 140, 51.5, 53.5), op_mott: 57.1, kp_mott: 48.9, op_fv: 54.7, op_alle: 55.4, n_mott: 77 },
          '2022': { ...Y(975, 171, 85, 70.2, 888, 138, 54.1, 53.5), op_mott: 58.4, kp_mott: 51.0, op_fv: 55.7, op_alle: 56.0, n_mott: 63 },
          '2023': { ...Y(880, 157, 75, 69.4, 793, 140, 52.4, 52.7), op_mott: 58.3, kp_mott: 50.4, op_fv: 56.1, op_alle: 56.3, n_mott: 77 },
          '2024': { ...Y(862, 155, 75, 73.5, 762, 124, 51.5, 53.7), op_mott: 58.0, kp_mott: 49.6, op_fv: 55.7, op_alle: 56.3, n_mott: 60 },
          '2025': { ...Y(860, 168, 75, 65.5, 771, 134, 50.7, 51.8), op_mott: 57.0, kp_mott: 49.3, op_fv: 55.1, op_alle: 56.0, n_mott: 75 },
      ...
      },
      {
        ...
        years: {
          '2020': Y(null, null, null, null, null, null, 0, 0),
          '2021': { ...Y(194, 22, 30, 31.8, 130, 28, 0, 0), op_mott: 46.2, kp_mott: 36.2, op_fv: 45.0, op_alle: 49.4, n_mott: 6 },
          '2022': { ...Y(164, 23, 20, 43.5, 112, 15, 0, 0), op_mott: 47.2, kp_mott: 38.1, op_fv: 47.8, op_alle: 49.5, n_mott: 10 },
          '2023': { ...Y(129, 25, 30, 56.0, 87, 16, 0, 0), op_mott: 47.5, kp_mott: 38.9, op_fv: 51.5, op_alle: 51.1, n_mott: 12 },
          '2024': { ...Y(98, 11, 20, 36.4, 64, 7, 0, 0), op_mott: 47.0, kp_mott: 41.5, op_fv: 44.1, op_alle: 48.9, n_mott: 5 },
          '2025': { ...Y(101, 8, 20, 25.0, 66, 5, 0, 0), op_mott: 54.4, kp_mott: 45.9, op_alle: 50.8, n_mott: 7 },
    ...
    entries: [
      {
        ...
        years: {
          '2020': Y(null, null, null, null, null, null, 0, 0),
          '2021': { ...Y(246, 30, 30, 80.0, 171, 49, 0, 0), op_mott: 51.8, kp_mott: 44.4, op_fv: 53.2, op_alle: 53.8, n_mott: 21 },
          '2022': { ...Y(195, 33, 30, 84.8, 138, 39, 0, 0), op_mott: 51.6, kp_mott: 46.3, op_fv: 50.9, op_alle: 54.9, n_mott: 17 },
          '2023': { ...Y(196, 26, 35, 80.8, 140, 27, 0, 0), op_mott: 50.4, kp_mott: 44.3, op_fv: 51.7, op_alle: 54.6, n_mott: 13 },
          '2024': { ...Y(179, 23, 35, 78.3, 108, 21, 0, 0), op_mott: 54.0, kp_mott: 44.0, op_fv: 51.9, op_alle: 54.8, n_mott: 7 },
          '2025': { ...Y(192, 21, 25, 85.7, 122, 17, 0, 0), op_mott: 56.1, kp_mott: 49.0, op_fv: 53.0, op_alle: 54.8, n_mott: 9 },
      ...
      },
      {
        ...
        years: {
          '2020': Y(null, null, null, null, null, null, 0, 0),
          '2021': { ...Y(191, 21, 32, 71.4, 174, 46, 0, 0), op_mott: 45.0, kp_mott: 39.0, op_fv: 44.9, op_alle: 46.0, n_mott: 19 },
          '2022': { ...Y(136, 22, 32, 72.7, 127, 34, 0, 0), op_mott: 46.5, kp_mott: 41.7, op_fv: 49.4, op_alle: 47.3, n_mott: 8 },
          '2023': { ...Y(156, 20, 32, 70.0, 139, 26, 0, 0), op_mott: 48.1, kp_mott: 43.8, op_fv: 47.8, op_alle: 46.8, n_mott: 13 },
          '2024': { ...Y(156, 26, 32, 84.6, 142, 32, 0, 0), op_mott: 46.1, kp_mott: 42.9, op_fv: 48.5, op_alle: 47.1, n_mott: 13 },
          '2025': { ...Y(133, 31, 25, 80.6, 126, 36, 0, 0), op_mott: 50.1, kp_mott: 44.4, op_fv: 50.2, op_alle: 47.5, n_mott: 13 },
      ...
      },
      {
        ...
        years: {
          '2020': Y(null, null, null, null, null, null, 0, 0),
          '2021': { ...Y(329, 62, 25, 66.1, 287, 60, 41.3, 45.8), op_mott: 51.7, kp_mott: 42.3, op_fv: 50.8, op_alle: 49.6, n_mott: 24 },
          '2022': { ...Y(266, 43, 25, 41.9, 247, 50, 36.3, 39.0), op_mott: 49.6, kp_mott: 44.7, op_fv: 48.4, op_alle: 49.4, n_mott: 20 },
          '2023': { ...Y(254, 46, 25, 71.7, 224, 54, 0, 0), op_mott: 47.7, kp_mott: 42.8, op_fv: 47.6, op_alle: 47.6, n_mott: 21 },
          '2024': { ...Y(233, 40, 25, 57.5, 200, 47, 0, 0), op_mott: 49.3, kp_mott: 42.3, op_fv: 48.2, op_alle: 48.4, n_mott: 15 },
          '2025': { ...Y(237, 42, 25, 45.2, 214, 42, 0, 0), op_mott: 46.2, kp_mott: 38.7, op_fv: 46.3, op_alle: 48.0, n_mott: 18 },
      ...
      },
      {
        ...
        years: {
          ...
          '2021': { ...Y(977, 228, 47, 94.7, 930, 114, 45.3, 50.8), op_mott: 51.9, kp_mott: 46.2, op_fv: 46.1, op_alle: 46.2, n_mott: 32 },
          '2022': { ...Y(769, 181, 47, 96.1, 727, 150, 42.7, 46.3), op_mott: 49.0, kp_mott: 43.8, op_fv: 45.4, op_alle: 46.0, n_mott: 30 },
          '2023': { ...Y(786, 173, 47, 95.4, 724, 170, 40.0, 45.7), op_mott: 49.0, kp_mott: 43.7, op_fv: 46.0, op_alle: 46.3, n_mott: 39 },
          '2024': { ...Y(693, 138, 47, 95.7, 641, 170, 36.2, 43.1), op_mott: 48.5, kp_mott: 42.7, op_fv: 46.0, op_alle: 45.5, n_mott: 33 },
          '2025': { ...Y(580, 119, 50, 94.1, 537, 187, 0, 0), op_mott: 45.3, kp_mott: 40.2, op_fv: 46.4, op_alle: 45.8, n_mott: 43 },
    ...
    entries: [
      {
        ...
        years: {
          '2020': Y(null, null, null, null, null, null, 0, 0),
          '2021': { ...Y(231, 44, 30, 56.8, 160, 45, 0, 0), op_mott: 50.7, kp_mott: 42.2, op_fv: 54.6, op_alle: 53.9, n_mott: 16 },
          '2022': { ...Y(196, 34, 30, 52.9, 146, 32, 0, 0), op_mott: 57.0, kp_mott: 48.3, op_fv: 58.3, op_alle: 57.4, n_mott: 11 },
          '2023': { ...Y(180, 25, 25, 44.0, 130, 19, 0, 0), op_mott: 51.4, kp_mott: 41.7, op_fv: 52.5, op_alle: 53.6, n_mott: 13 },
          '2024': { ...Y(165, 24, 25, 58.3, 107, 13, 0, 0), op_mott: 53.3, kp_mott: 44.0, op_fv: 48.9, op_alle: 54.7, n_mott: 11 },
          '2025': { ...Y(171, 31, 25, 61.3, 121, 26, 0, 0), op_mott: 52.7, kp_mott: 44.0, op_fv: 53.2, op_alle: 55.0, n_mott: 17 },
      ...
      },
      {
        ...
        years: {
          '2020': Y(null, null, null, null, null, null, 0, 0),
          '2021': { ...Y(110, 17, 20, 17.6, 105, 31, 0, 0), op_mott: 45.8, kp_mott: 39.5, op_fv: 43.6, op_alle: 46.9, n_mott: 14 },
          '2022': { ...Y(80, 13, 25, 15.4, 74, 17, 0, 0), op_mott: 49.5, kp_mott: 43.3, op_fv: 51.7, op_alle: 49.1, n_mott: 7 },
          '2023': { ...Y(97, 21, 25, 4.8, 86, 20, 0, 0), op_mott: 49.7, kp_mott: 46.0, op_fv: 49.4, op_alle: 48.9, n_mott: 9 },
          '2024': { ...Y(96, 15, 25, 26.7, 88, 20, 0, 0), op_mott: 49.1, kp_mott: 44.5, op_fv: 49.0, op_alle: 48.9, n_mott: 16 },
          '2025': { ...Y(83, 15, 25, 6.7, 77, 19, 0, 0), op_mott: 47.7, kp_mott: 43.7, op_fv: 49.4, op_alle: 47.5, n_mott: 11 },
    ...
    entries: [
      {
        ...
        years: {
          '2021': { ...Y(466, 53, 25, 52.8, 331, 50, 44.9, 46.6), op_mott: 50.8, kp_mott: 44.1, op_fv: 50.4, op_alle: 51.6, n_mott: 13 },
          '2022': { ...Y(395, 39, 25, 41.0, 262, 49, 0, 0), op_mott: 50.4, kp_mott: 42.5, op_fv: 49.3, op_alle: 52.4, n_mott: 8 },
          '2023': { ...Y(369, 37, 30, 56.8, 255, 35, 0, 0), op_mott: 46.2, kp_mott: 41.8, op_fv: 49.5, op_alle: 52.9, n_mott: 13 },
          '2024': { ...Y(363, 51, 30, 54.9, 247, 41, 0, 0), op_mott: 51.3, kp_mott: 43.7, op_fv: 51.3, op_alle: 51.5, n_mott: 14 },
          '2025': { ...Y(337, 34, 30, 50.0, 234, 33, 0, 0), op_mott: 52.9, kp_mott: 44.2, op_fv: 55.0, op_alle: 52.9, n_mott: 11 },
      ...
      },
      {
        ...
        years: {
          ...
          '2021': { ...Y(874, 219, 50, 38.4, 844, 110, 44.2, 49.4), op_mott: 50.8, kp_mott: 45.0, op_fv: 44.9, op_alle: 45.3, n_mott: 34 },
          '2022': { ...Y(716, 174, 50, 43.1, 688, 140, 42.2, 46.6), op_mott: 50.0, kp_mott: 43.5, op_fv: 46.3, op_alle: 45.9, n_mott: 40 },
          '2023': { ...Y(795, 202, 50, 43.1, 740, 150, 42.2, 47.5), op_mott: 50.6, kp_mott: 44.8, op_fv: 46.7, op_alle: 46.6, n_mott: 54 },
          '2024': { ...Y(692, 139, 50, 46.0, 654, 150, 39.2, 44.1), op_mott: 47.2, kp_mott: 42.1, op_fv: 47.1, op_alle: 46.5, n_mott: 45 },
          '2025': { ...Y(582, 136, 50, 50.7, 546, 186, 0, 0), op_mott: 46.4, kp_mott: 41.6, op_fv: 45.5, op_alle: 46.3, n_mott: 61 },
      ...
      },
      {
        ...
        years: {
          ...
          '2021': { ...Y(995, 147, 40, 53.1, 970, 98, 46.7, 49.5), op_mott: 52.0, kp_mott: 46.7, op_fv: 47.6, op_alle: 48.7, n_mott: 29 },
          '2022': { ...Y(782, 125, 35, 55.2, 753, 80, 49.5, 50.5), op_mott: 53.7, kp_mott: 47.2, op_fv: 49.3, op_alle: 50.1, n_mott: 29 },
          '2023': { ...Y(742, 126, 35, 58.7, 703, 90, 48.1, 49.9), op_mott: 53.7, kp_mott: 47.0, op_fv: 49.0, op_alle: 50.9, n_mott: 30 },
          '2024': { ...Y(835, 130, 40, 62.3, 805, 120, 46.8, 48.0), op_mott: 52.9, kp_mott: 46.6, op_fv: 49.2, op_alle: 50.4, n_mott: 35 },
          '2025': { ...Y(784, 107, 43, 67.3, 751, 118, 45.9, 46.1), op_mott: 52.1, kp_mott: 45.5, op_fv: 48.6, op_alle: 49.6, n_mott: 39 },
      ...
      },
      {
        ...
        years: {
          ...
          '2021': { ...Y(554, 57, 35, 42.1, 445, 52, 49.2, 53.5), op_mott: 54.4, kp_mott: 46.5, op_fv: 54.7, op_alle: 53.8, n_mott: 32 },
          '2022': { ...Y(627, 63, 35, 50.8, 486, 55, 48.7, 53.6), op_mott: 53.2, kp_mott: 45.3, op_fv: 53.5, op_alle: 53.5, n_mott: 30 },
          '2023': { ...Y(627, 63, 35, 49.2, 480, 67, 49.8, 53.2), op_mott: 54.7, kp_mott: 46.8, op_fv: 53.0, op_alle: 54.0, n_mott: 36 },
          '2024': { ...Y(715, 73, 45, 46.6, 550, 77, 49.3, 53.0), op_mott: 56.0, kp_mott: 47.9, op_fv: 54.5, op_alle: 54.5, n_mott: 45 },
          '2025': { ...Y(741, 57, 45, 50.9, 581, 77, 47.6, 49.5), op_mott: 53.0, kp_mott: 45.6, op_fv: 52.4, op_alle: 53.6, n_mott: 41 },
      ...
      },
      {
        ...
        years: {
          ...
          '2021': { ...Y(235, 43, 20, 62.8, 137, 30, 0, 52.6), op_mott: 55.5, kp_mott: 45.4, op_fv: 54.3, op_alle: 54.4, n_mott: 18 },
          '2022': { ...Y(430, 62, 20, 53.2, 270, 30, 48.2, 55.7), op_mott: 54.3, kp_mott: 47.3, op_fv: 51.5, op_alle: 54.1, n_mott: 14 },
          '2023': { ...Y(398, 57, 20, 59.6, 263, 33, 51.9, 56.0), op_mott: 59.1, kp_mott: 50.0, op_fv: 54.2, op_alle: 55.7, n_mott: 12 },
          '2024': { ...Y(388, 44, 20, 52.3, 264, 34, 49.7, 55.5), op_mott: 57.7, kp_mott: 48.9, op_fv: 55.4, op_alle: 55.9, n_mott: 18 },
          '2025': { ...Y(373, 36, 20, 58.3, 246, 35, 46.4, 52.2), op_mott: 55.8, kp_mott: 46.1, op_fv: 55.7, op_alle: 56.1, n_mott: 19 },
      ...
      },
      {
        ...
        years: {
          ...
          '2021': { ...Y(364, 81, 28, 74.1, 324, 48, 47.2, 53.1), op_mott: 54.1, kp_mott: 47.3, op_fv: 51.4, op_alle: 52.8, n_mott: 16 },
          '2022': { ...Y(464, 91, 28, 69.2, 417, 48, 50.5, 57.7), op_mott: 58.3, kp_mott: 50.0, op_fv: 53.2, op_alle: 54.4, n_mott: 16 },
          '2023': { ...Y(421, 76, 25, 68.4, 369, 45, 52.0, 58.0), op_mott: 58.1, kp_mott: 50.5, op_fv: 55.1, op_alle: 55.8, n_mott: 20 },
          '2024': { ...Y(420, 82, 25, 74.4, 373, 50, 50.1, 56.4), op_mott: 57.6, kp_mott: 48.9, op_fv: 54.6, op_alle: 55.7, n_mott: 21 },
          '2025': { ...Y(370, 57, 25, 73.7, 301, 53, 44.0, 56.3), op_mott: 55.6, kp_mott: 47.4, op_fv: 55.3, op_alle: 55.0, n_mott: 19 },
