// GENERERT av scripts/build-biovit-data.py – stub. Ikke rediger for hånd.
// Tom foreløpig: generatoren skriver over hele filen når BIOVIT-tallene legges inn.
// Eksportnavnene er med vilje de samme som i landsamAdmissionData.ts, slik at
// generatoren kan gjenbrukes; registeret i faculties.ts gir dem BIOVIT-navn.
