    ...
    entries: [
      {
        ...
        years: {
          ...
          '2021': Y(685, 73, 40, 75.3, 637, 56, 56.0, 56.0),
          '2022': Y(528, 63, 40, 74.6, 484, 56, 55.1, 55.0),
          '2023': Y(576, 79, 40, 67.1, 522, 70, 53.0, 52.0),
          '2024': Y(656, 79, 40, 69.6, 591, 72, 51.7, 51.7),
          '2025': Y(563, 72, 40, 69.4, 509, 72, 49.0, 50.5),
      ...
      },
      {
        ...
        years: {
          ...
          '2021': Y(320, 17, 15, 70.6, 287, 30, 48.3, 49.5),
          '2022': Y(279, 18, 15, 61.1, 254, 35, 0, 0),
          '2023': Y(267, 21, 15, 33.3, 213, 30, 0, 0),
          '2024': Y(214, 8, 15, 75.0, 179, 15, 0, 0),
          '2025': Y(185, 9, 10, 33.3, 158, 13, 0, 0),
      ...
      },
      {
        ...
        years: {
          ...
          '2021': Y(506, 34, 24, 55.9, 451, 46, 50.3, 50.4),
          '2022': Y(332, 26, 20, 53.8, 301, 40, 48.2, 45.1),
          '2023': Y(359, 26, 20, 69.2, 301, 40, 49.6, 46.0),
          '2024': Y(324, 27, 20, 59.3, 273, 52, 0, 0),
          '2025': Y(289, 20, 19, 60.0, 234, 31, 0, 0),
        },
      },
      {
        ...
        years: {
          ...
          '2021': Y(1165, 172, 45, 73.3, 1118, 102, 58.2, 60.0),
          '2022': Y(922, 148, 35, 70.3, 903, 74, 58.3, 61.2),
          '2023': Y(961, 137, 35, 86.9, 916, 92, 57.7, 59.3),
          '2024': Y(923, 150, 35, 78.7, 881, 78, 57.0, 60.5),
          '2025': Y(824, 129, 35, 73.6, 781, 78, 56.2, 59.4),
      ...
      },
      {
        ...
        years: {
          '2020': Y(null, null, null, null, null, null, 0, 0),
          '2021': Y(583, 55, 40, 63.6, 317, 61, 0, 0),
          '2022': Y(555, 60, 40, 58.3, 311, 47, 0, 0),
          '2023': Y(540, 56, 35, 76.8, 259, 47, 0, 0),
          '2024': Y(502, 49, 40, 51.0, 254, 48, 0, 0),
          '2025': Y(524, 54, 47, 63.0, 286, 50, 0, 0),
    ...
    entries: [
      {
        ...
        years: {
          ...
          '2021': Y(238, 21, 20, 57.1, 211, 26, 49.5, 52.6),
          '2022': Y(230, 28, 20, 60.7, 212, 28, 39.5, 50.5),
          '2023': Y(212, 20, 20, 65.0, 192, 34, 46.1, 41.5),
          '2024': Y(210, 22, 20, 36.4, 179, 30, 0, 0),
          '2025': Y(173, 21, 20, 71.4, 153, 30, 0, 0),
      ...
      },
      {
        ...
        years: {
          ...
          '2021': Y(473, 46, 44, 69.6, 314, 61, 0, 0),
          '2022': Y(453, 49, 40, 65.3, 316, 63, 0, 0),
          '2023': Y(429, 52, 40, 55.8, 286, 50, 0, 0),
          '2024': Y(417, 54, 40, 61.1, 279, 50, 0, 0),
          '2025': Y(428, 56, 40, 48.2, 294, 53, 0, 0),
      ...
      },
      {
        ...
        years: {
          '2020': Y(null, null, null, null, null, null, 0, 0),
          '2021': Y(320, 23, 35, 47.8, 277, 60, 0, 0),
          '2022': Y(350, 45, 35, 48.9, 319, 60, 0, 0),
          '2023': Y(293, 29, 35, 34.5, 263, 48, 0, 0),
          '2024': Y(322, 33, 35, 51.5, 287, 49, 0, 0),
          '2025': Y(305, 43, 35, 44.2, 269, 46, 0, 0),
      ...
      },
      {
        ...
        years: {
          ...
          '2021': Y(411, 31, 40, 54.8, 331, 58, 47.7, 47.0),
          '2022': Y(431, 52, 40, 53.8, 353, 68, 48.7, 48.0),
          '2023': Y(336, 37, 40, 37.8, 263, 50, 47.2, 46.4),
          '2024': Y(369, 42, 35, 50.0, 290, 54, 50.2, 47.9),
          '2025': Y(375, 43, 35, 44.2, 310, 48, 48.2, 47.5),
      ...
      },
      {
        ...
        years: {
          ...
          '2021': Y(409, 62, 30, 64.5, 320, 60, 41.9, 48.4),
          '2022': Y(346, 59, 30, 66.1, 295, 60, 39.8, 47.5),
          '2023': Y(298, 40, 30, 67.5, 242, 55, 0, 0),
          '2024': Y(315, 51, 30, 64.7, 247, 57, 0, 0),
          '2025': Y(301, 42, 30, 54.8, 226, 38, 0, 0),
      ...
      },
      {
        ...
        years: {
          '2020': Y(null, null, null, null, null, null, 0, 0),
          '2021': Y(71, 5, 18, 40.0, 46, 3, 0, 0),
          '2022': Y(72, 6, 18, 66.7, 61, 6, 0, 0),
          '2023': Y(58, 3, 18, 100.0, 40, 2, 0, 0),
          '2024': Y(98, 9, 18, 44.4, 80, 8, 0, 0),
        },
      },
      {
    ...
    entries: [
      ...
      },
      {
        ...
        years: {
          ...
          '2021': Y(458, 61, 34, 85.2, 210, 70, 0, 48.6),
          '2022': Y(444, 49, 34, 93.9, 176, 60, 0, 0),
          '2023': Y(565, 62, 34, 80.6, 184, 48, 0, 0),
          '2024': Y(661, 58, 34, 81.0, 175, 42, 0, 0),
          '2025': Y(570, 59, 34, 78.0, 141, 40, 0, 0),
      ...
      },
      {
        ...
        years: {
          '2020': Y(null, null, null, null, null, null, 0, 0),
          '2021': Y(266, 27, 15, 88.9, 98, 19, 0, 0),
          '2022': Y(262, 14, 15, 85.7, 79, 16, 0, 0),
          '2023': Y(180, 15, 15, 86.7, 60, 12, 0, 0),
          '2024': Y(173, 14, 15, 78.6, 60, 6, 0, 0),
          '2025': Y(179, 9, 15, 66.7, 50, 6, 0, 0),
      ...
      },
      {
        ...
        years: {
          ...
          '2021': Y(828, 110, 35, 86.4, 573, 100, 53.4, 61.1),
          '2022': Y(740, 105, 35, 87.6, 515, 100, 54.0, 60.0),
          '2023': Y(692, 101, 35, 87.1, 432, 80, 51.4, 59.6),
          '2024': Y(642, 90, 48, 81.1, 351, 92, 0, 56.4),
          '2025': Y(638, 91, 48, 80.2, 318, 100, 0, 51.8),
    ...
    entries: [
      {
        ...
        url: 'https://www.nmbu.no/studier/bachelor/mat-teknologi-og-helse',
        years: {
          '2025': Y(213, 26, 20, 80.8, 162, 23, 0, 0),
      ...
      },
      {
        ...
        years: {
          '2020': Y(null, null, null, null, null, null, 0, 0),
          '2021': Y(477, 83, 45, 59.0, 387, 80, 46.5, 47.8),
          '2022': Y(419, 72, 45, 65.3, 339, 78, 45.0, 47.6),
          '2023': Y(307, 54, 45, 81.5, 251, 50, 43.0, 48.5),
          '2024': Y(349, 48, 38, 81.2, 289, 62, 48.5, 49.4),
          '2025': Y(355, 44, 38, 65.9, 289, 50, 44.8, 45.6),
    ...
    entries: [
      {
        ...
        years: {
          '2021': Y(179, 118, null, 78.0, 118, 90, null, null),
          '2022': Y(153, 101, null, 85.1, 99, 77, null, null),
          '2023': Y(163, 104, null, 81.7, 91, 76, null, null),
          '2024': Y(154, 91, null, 83.5, 99, 64, null, null),
          '2025': Y(160, 104, null, 75.0, 100, 85, null, 3.0),
      ...
      },
      {
        ...
        years: {
          '2021': Y(131, 64, null, 73.4, 64, 39, null, null),
          '2022': Y(114, 48, null, 75.0, 56, 35, null, null),
          '2023': Y(107, 57, null, 68.4, 39, 29, null, null),
          '2024': Y(140, 78, null, 70.5, 57, 42, null, null),
          '2025': Y(187, 60, null, 63.3, 61, 38, null, null),
      ...
      },
      {
        ...
        years: {
          '2021': Y(607, 334, null, 52.1, 266, 52, null, null),
          '2022': Y(724, 439, null, 57.2, 289, 59, null, null),
          '2023': Y(616, 346, null, 50.3, 163, 67, null, null),
          '2024': Y(216, 76, null, 77.6, 143, 56, null, null),
          '2025': Y(251, 97, null, 69.1, 153, 60, null, null),
        },
      },
    ],
  },
    ...
    entries: [
      {
        ...
        years: {
          '2021': Y(55, 26, null, 53.8, 42, 27, null, null),
          '2022': Y(90, 32, null, 62.5, 41, 26, null, null),
          '2023': Y(80, 39, null, 69.2, 37, 21, null, null),
          '2024': Y(39, 16, null, 75.0, 22, 13, null, null),
          '2025': Y(48, 28, null, 64.3, 29, 26, null, 2.6),
      ...
      },
      {
        ...
        years: {
          '2021': Y(355, 159, null, 54.1, 122, 56, null, null),
          '2022': Y(365, 155, null, 56.1, 126, 56, null, null),
          '2023': Y(336, 145, null, 51.7, 101, 36, null, null),
          '2024': Y(240, 95, null, 61.1, 104, 47, null, null),
          '2025': Y(254, 98, null, 56.1, 121, 49, null, null),
        },
      },
      {
        ...
        years: {
          '2021': Y(43, 33, null, 33.3, 28, 24, null, null),
          '2022': Y(51, 42, null, 57.1, 34, 33, null, null),
          '2023': Y(32, 24, null, 70.8, 23, 18, null, null),
          '2024': Y(51, 37, null, 48.6, 28, 25, null, null),
          '2025': Y(61, 45, null, 46.7, 39, 32, null, null),
      ...
      },
      {
        ...
        years: {
          '2021': Y(197, 114, null, 45.6, 73, 31, null, null),
          '2022': Y(207, 129, null, 45.0, 60, 27, null, null),
          '2023': Y(192, 124, null, 46.0, 46, 29, null, null),
          '2024': Y(65, 21, null, 52.4, 29, 14, null, null),
          '2025': Y(93, 42, null, 45.2, 50, 25, null, null),
        },
      },
    ],
  },
    ...
    entries: [
      {
        ...
        years: {
          '2025': Y(39, 11, null, 63.6, 4, 0, null, null),
          '2026': Y(null, null, 20, null, null, null, null, null),
        },
      },
      {
        ...
        years: {
          '2021': Y(111, 40, null, 75.0, 88, 38, null, null),
          '2022': Y(85, 33, null, 60.6, 69, 35, null, null),
          '2023': Y(70, 17, null, 100.0, 57, 22, null, null),
          '2024': Y(95, 35, null, 68.6, 74, 36, null, null),
          '2025': Y(78, 18, null, 100.0, 60, 20, null, null),
        },
      },
    ],
  },
