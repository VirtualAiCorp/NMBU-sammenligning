// GENERERT av scripts/build-kbm-data.py – stub. Ikke rediger for hånd.
// Tom foreløpig: generatoren skriver over hele filen når KBM-tallene legges inn.
// Eksportnavnene er med vilje de samme som i landsamAdmissionData.ts, slik at
// generatoren kan gjenbrukes; registeret i faculties.ts gir dem KBM-navn.
