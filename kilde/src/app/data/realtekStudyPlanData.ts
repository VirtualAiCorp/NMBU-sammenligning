// GENERERT av scripts/build-realtek-studyplans.py – stub. Ikke rediger for hånd.
// Tom foreløpig: generatoren skriver over hele filen når studieplanene for REALTEK er lagt inn.
