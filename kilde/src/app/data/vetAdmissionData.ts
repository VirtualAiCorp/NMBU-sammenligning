    ...
    entries: [
      {
        ...
        years: {
          ...
          '2021': { ...Y(1265, 600, 90, 90.3, 1035, 126, 57.3, 64.8), op_mott: 62.5, kp_mott: 54.3, op_fv: 57.3, op_alle: 57.4, n_mott: 77 },
          '2022': { ...Y(1105, 514, 90, 91.4, 907, 144, 57.7, 64.4), op_mott: 63.3, kp_mott: 54.2, op_fv: 57.9, op_alle: 58.0, n_mott: 81 },
          '2023': { ...Y(1005, 496, 90, 90.1, 784, 172, 56.3, 63.6), op_mott: 62.5, kp_mott: 53.7, op_fv: 57.6, op_alle: 57.5, n_mott: 82 },
          '2024': { ...Y(973, 457, 80, 87.1, 793, 136, 55.7, 63.6), op_mott: 62.6, kp_mott: 53.9, op_fv: 57.2, op_alle: 57.2, n_mott: 77 },
          '2025': { ...Y(897, 441, 90, 90.2, 729, 176, 53.5, 62.1), op_mott: 60.6, kp_mott: 52.6, op_fv: 56.4, op_alle: 56.3, n_mott: 82 },
      ...
      },
      {
        ...
        years: {
          ...
          '2021': { ...Y(3023, 1121, 120, 71.5, 2518, 135, 62.0, 69.5), op_mott: 66.8, kp_mott: 57.8, op_fv: 61.5, op_alle: 61.6, n_mott: 93 },
          '2022': { ...Y(2697, 988, 120, 69.6, 2282, 135, 62.4, 69.6), op_mott: 66.8, kp_mott: 57.9, op_fv: 61.8, op_alle: 61.9, n_mott: 103 },
          '2023': { ...Y(2512, 930, 120, 67.5, 2069, 135, 61.2, 70.2), op_mott: 67.0, kp_mott: 57.6, op_fv: 61.6, op_alle: 61.8, n_mott: 97 },
          '2024': { ...Y(2111, 766, 115, 66.7, 1735, 145, 60.7, 69.7), op_mott: 66.7, kp_mott: 57.3, op_fv: 60.4, op_alle: 60.6, n_mott: 113 },
          '2025': { ...Y(1800, 710, 110, 71.5, 1447, 150, 60.5, 69.6), op_mott: 65.5, kp_mott: 56.7, op_fv: 60.4, op_alle: 60.8, n_mott: 126 },
      ...
      },
      {
        ...
        years: {
          ...
          '2021': { ...Y(3325, 838, 185, 74.1, 2848, 275, 60.5, 68.1), op_mott: 66.0, kp_mott: 56.9, op_fv: 61.2, op_alle: 61.1, n_mott: 127 },
          '2022': { ...Y(3035, 749, 185, 76.0, 2662, 280, 60.8, 68.3), op_mott: 66.4, kp_mott: 57.0, op_fv: 61.7, op_alle: 61.5, n_mott: 127 },
          '2023': { ...Y(2905, 705, 185, 73.5, 2510, 260, 60.1, 68.6), op_mott: 65.9, kp_mott: 56.7, op_fv: 61.9, op_alle: 61.5, n_mott: 134 },
          '2024': { ...Y(2584, 629, 165, 75.2, 2240, 260, 59.4, 67.8), op_mott: 65.6, kp_mott: 56.4, op_fv: 60.0, op_alle: 60.0, n_mott: 161 },
          '2025': { ...Y(2059, 493, 165, 77.3, 1761, 260, 58.5, 67.2), op_mott: 64.8, kp_mott: 55.7, op_fv: 60.7, op_alle: 60.6, n_mott: 189 },
      ...
      },
      {
        ...
        years: {
          ...
          '2021': { ...Y(3161, 1027, 155, 71.1, 2692, 190, 62.0, 68.6), op_mott: 66.9, kp_mott: 57.4, op_fv: 62.2, op_alle: 62.2, n_mott: 136 },
          '2022': { ...Y(2782, 802, 119, 73.3, 2442, 150, 62.5, 69.2), op_mott: 66.8, kp_mott: 57.7, op_fv: 60.4, op_alle: 60.4, n_mott: 134 },
          '2023': { ...Y(2515, 777, 119, 71.4, 2144, 160, 62.2, 69.6), op_mott: 67.1, kp_mott: 58.0, op_fv: 62.1, op_alle: 62.3, n_mott: 137 },
          '2024': { ...Y(1897, 574, 119, 75.8, 1660, 160, 61.7, 69.4), op_mott: 67.0, kp_mott: 57.2, op_fv: 62.3, op_alle: 62.6, n_mott: 161 },
          '2025': { ...Y(1663, 571, 119, 73.6, 1416, 194, 61.0, 68.5), op_mott: 66.2, kp_mott: 56.8, op_fv: 62.5, op_alle: 62.2, n_mott: 210 },
      ...
      },
      {
        ...
        years: {
          ...
          '2021': { ...Y(2965, 521, 136, 68.3, 2586, 180, 60.3, 68.0), op_mott: 62.5, kp_mott: 53.6, op_fv: 58.7, op_alle: 58.6, n_mott: 113 },
          '2022': { ...Y(2684, 453, 151, 70.2, 2389, 220, 60.4, 68.2), op_mott: 62.5, kp_mott: 53.4, op_fv: 59.3, op_alle: 59.2, n_mott: 103 },
          '2023': { ...Y(2590, 507, 181, 67.3, 2245, 240, 59.8, 68.2), op_mott: 60.9, kp_mott: 52.1, op_fv: 58.7, op_alle: 58.6, n_mott: 124 },
          '2024': { ...Y(2047, 415, 181, 64.8, 1741, 260, 57.8, 66.8), op_mott: 59.8, kp_mott: 51.4, op_fv: 58.0, op_alle: 58.4, n_mott: 130 },
          '2025': { ...Y(2167, 508, 181, 67.1, 1868, 260, 57.1, 66.0), op_mott: 58.4, kp_mott: 50.6, op_fv: 57.0, op_alle: 56.9, n_mott: 135 },
    ...
    entries: [
      {
        ...
        years: {
          ...
          '2021': { ...Y(682, 117, 30, 88.9, 390, 46, 48.9, 56.1), op_mott: 55.8, kp_mott: 46.9, op_fv: 51.5, op_alle: 53.7, n_mott: 24 },
          '2022': { ...Y(550, 99, 30, 96.0, 313, 48, 48.5, 54.3), op_mott: 55.4, kp_mott: 47.3, op_fv: 53.1, op_alle: 54.1, n_mott: 28 },
          '2023': { ...Y(509, 78, 30, 93.6, 286, 58, 45.1, 54.1), op_mott: 52.0, kp_mott: 44.0, op_fv: 53.1, op_alle: 53.6, n_mott: 25 },
          '2024': { ...Y(522, 77, 30, 94.8, 263, 64, 40.5, 50.4), op_mott: 52.0, kp_mott: 44.8, op_fv: 51.0, op_alle: 54.4, n_mott: 27 },
          '2025': { ...Y(456, 80, 34, 93.8, 236, 79, 0, 0), op_mott: 49.9, kp_mott: 42.2, op_fv: 52.2, op_alle: 53.1, n_mott: 38 },
