    ...
    programs: [
      {
        ...
        obligatoriske: [
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: 'Augustblokk. Obligatorisk valg mellom STAT210 (tas i augustblokk) og STAT200 Regresjon (tas i januarblokk) - studieplanen krever minst ett av de to.',
            years: [],
          },
          {
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: 'Studieplanen lister PHI100/PHI101 sammen (alt. PHI101/PHI102) - studenten velger en av de likeverdige variantene.',
            years: [],
          },
          {
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: 'Obligatorisk valg mellom BIO211 (tas i januarblokk) og BIO233 Eksperimentell miljømikrobiologi (tas i vårsemesteret) - studieplanen krever minst ett av de to.',
            years: [],
          },
          {
    ...
    programs: [
      {
        ...
        obligatoriske: [
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: 'Obligatorisk valg mellom MATH100 og MATH121 (studieplanen lister «Matematikk MATH100 eller MATH121»).',
            years: [],
          },
          {
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: 'Studieplanen lister PHI100 (alt. PHI101/PHI102) - studenten velger en av de likeverdige variantene.',
            years: [],
          },
          {
