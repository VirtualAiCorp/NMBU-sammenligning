      ...
      },
      {
        ...
        obligatoriske: [
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: 'Tas på ulikt tidspunkt avhengig av studieretning (typisk 3. eller 5. semester ifølge kildene for de tre retningene).',
            years: [],
          },
        ],
        spesialiseringer: [
          ...
          { navn: 'Biomangfold, økologi og evolusjon', obligatoriske: [
            ...
            },
            {
              ...
              dbhEmnekoder: [], merknad: 'Obligatorisk valg mellom STK1000 og MAT1050 Matematikk for anvendelser 1.',
              years: [],
            },
          ] },
          { navn: 'Molekylærbiologi og biomedisin', obligatoriske: [
            ...
            },
            {
              ...
              dbhEmnekoder: [], merknad: 'Obligatorisk valg mellom BIOS3601 og BIOS3800 Humanfysiologi.',
              years: [],
            },
            {
              emnekode: 'STK1000', emnenavn: 'Innføring i anvendt statistikk', studiepoeng: 10, aar: 2, semester: 'høst',
    ...
    programs: [
      ...
      },
      {
        ...
        obligatoriske: [
          ...
          {
            emnekode: 'MAT101', emnenavn: 'Brukarkurs i matematikk I', studiepoeng: 10, aar: 1, semester: 'høst',
            dbhEmnekoder: [], merknad: 'Studiet lister MAT101 som utgangspunkt; MAT111 Grunnkurs i matematikk I kan trolig erstatte, som for andre UiB-bachelorprogram (ikke eksplisitt bekreftet for kjemi).',
            years: [],
          },
          {
            emnekode: 'KJEM110', emnenavn: 'Kjemi og energi', studiepoeng: 10, aar: 1, semester: 'høst',
        ...
        spesialiseringer: [
          { navn: 'Fag 2 Biologi/bio-organisk', obligatoriske: [
            ...
            },
            {
              ...
              dbhEmnekoder: [], merknad: 'Kan alternativt tas som KJ2910 (15 sp, større omfang).',
              years: [],
            },
          ] },
      ...
      },
      {
        ...
        obligatoriske: [
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: 'Går over 1. og 2. semester, 0 studiepoeng.',
            years: [],
          },
          {
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: 'Administrativt oppført som løpende over 5. og 6. semester, men med hele sp-summen (20 sp) først bekreftet ved 6. semester i kilden.',
            years: [],
          },
        ],
        spesialiseringer: [
      ...
      },
      {
        ...
        obligatoriske: [
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: 'Studiepoeng ikke eksplisitt bekreftet i kildene brukt her (antatt 10 sp iht. UiBs standard bacheloroppgave-emner); bør verifiseres.',
            years: [],
          },
        ],
        spesialiseringer: [
      ...
      },
      {
        ...
        obligatoriske: [
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: 'Spenner over 2. og 3. semester ifølge kilden (oppgitt samlet til 50 sp ved 3. semester, uten egen delt sp-verdi for 2. semester-delen); ført opp i 2. semester (vår, år 1) som startpunkt.',
            years: [],
          },
          {
            emnekode: 'ERN2200R', emnenavn: 'Fysiologi, ernæring og medisinsk biokjemi', studiepoeng: 15, aar: 2, semester: 'vår',
            dbhEmnekoder: [], merknad: 'Kilden oppgir ikke eksakt sp-fordeling mellom ERN2200R og ERN2300 i 4. semester (kun at de to til sammen utgjør semesterets 30 sp); delt likt (15/15) her som beste anslag - bør verifiseres.',
            years: [],
          },
          {
            ...
            dbhEmnekoder: [], merknad: 'Se merknad på ERN2200R om usikker sp-fordeling.',
            years: [],
          },
          {
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: '60 sp totalt, fordelt over 9. og 10. semester (5. år).',
            years: [],
          },
        ],
        spesialiseringer: [
      ...
      },
      {
        ...
        obligatoriske: [
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: 'Emnet dekker fiskeribiologi, ressursøkonomi, forvaltning og redskapsteknologi (7,5 sp hver, samlet i ett emne på 30 sp).',
            years: [],
          },
          {
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: 'Obligatorisk valg mellom FSK-2043, BIO-2002 Dyrefysiologi og GIS (alle 10 sp).',
            years: [],
          },
        ],
        spesialiseringer: [
      ...
      },
      {
        ...
        obligatoriske: [
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: '60 sp totalt, fordelt over alle 4 semestre (del 1-4). Emnekoden avhenger av hvilket institutt oppgaven tas ved: BIOTBA3901 (IBA Ålesund), BIOTBI3901 (Institutt for biologi), BIOTBT3901 (Institutt for bioteknologi og matvitenskap) eller HBIOT3911 (bioingeniørfag).',
            years: [],
          },
          {
        ...
        obligatoriske: [
          {
            ...
            dbhEmnekoder: [], merknad: '60 sp, leveres innen 1. juni eller 15. november i løpet av 4. semester.',
            years: [],
          },
        ],
        spesialiseringer: [
      ...
      },
      {
        ...
        obligatoriske: [
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: '60 sp totalt, delt i 4 deler fordelt over alle 4 semestre (del 1-4 ifølge studieplanen).',
            years: [],
          },
        ],
        spesialiseringer: [
      ...
      },
      {
        ...
        obligatoriske: [
          ...
          },
          {
            ...
            dbhEmnekoder: [], merknad: 'Obligatorisk valg mellom MATV4008 og TBT4507 (ifølge studieplanens fotnote); studenter med tidligere MTMAT-bachelor kan ikke velge MATV3002 eller MATV3004 som erstatning.',
            years: [],
          },
          {
