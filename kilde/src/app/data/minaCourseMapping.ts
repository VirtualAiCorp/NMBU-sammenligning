// GENERERT av scripts/build-mina-course-mapping.py – stub. Ikke rediger for hånd.
// Tom foreløpig: generatoren skriver over hele filen når emnekoblingen for MINA er laget.
