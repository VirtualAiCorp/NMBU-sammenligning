...
export const LANDSAM_COURSE_MAPPING: GroupCourseMapping[] = [
  {
    groupId: 'fornybar',
    note: 'Gruppa sammenligner ett tverrfaglig universitetsløp med fem ingeniørutdanninger, og forskjellen preger hele emnekoblingen. NMBUs bachelor i fornybar energi bygger på brukerkurs i matematikk og fysikk og kombinerer energifag med økonomi, juss, økologi og arealplanlegging. HVLs bachelor i Sogndal (siste opptak 2024) er den nærmeste parallellen og er like tverrfaglig. NTNU, UiA og UiT har ingeniørløp med R1+R2+FYS1 i opptakskravet, tre til fire matematikkemner, kretsteknikk, termodynamikk og mekanikk. Tre emnetyper er derfor ikke satt opp, fordi NMBU ikke har noe tilsvarende emne: termodynamikk og varmelære (NTNU FENT1011/FENT2010, UiA ENE113, UiT PRO-2604), elektroteknikk og kretslære (NTNU ELET1001/ELET1002 og IELET1001, UiA ELE113/ELE114/ENE235/ENE236, UiT AUT-2503) og mekanikk (NTNU MEKT1101, UiA ENE114). Det samme gjelder bacheloroppgaven: NMBUs bachelor i fornybar energi har ingen obligatorisk avsluttende oppgave, mens HVL (FE403, 20 sp), NTNU (FENT2900, 20 sp) og UiA (ENE304/ENE306, 20–30 sp) alle har det. NTNU tar opp til fornybar energi-ingeniør på tre studiesteder med hver sin studiekode, men rapporterer alle tre under én DBH-programkode, slik at emnelisten er identisk for ntnu_ing_fornybar_trondheim, _gjovik og _alesund. For å skille studiestedene er hvert studiested koblet til sine egne emnekoder: NTNUs koder har studiestedet i fjerde bokstav (T = Trondheim, G = Gjøvik, A = Ålesund), for eksempel FENT/FENG/FENA, IMAT/IMAG/IMAA og ISTT/ISTG/ISTA. UiTs femårige sivilingeniørløp har svært få rapporterte kandidater per emne (høyest 11), så UiT-tallene er usikre.',
    courseTypes: [
      {
        id: 'matematikk', label: 'Matematikk', kategori: 'Realfag',
        desc: 'Første matematikkemne: funksjoner, derivasjon, integrasjon og enkel lineær algebra.',
        note: 'Nivåforskjellen er den største i gruppa. NMBU har bare brukerkurset MATH100 (10 sp), mens ingeniørløpene har tre til fire matematikkemner: NTNU har Matematikk for ingeniørfag 1–3 og Matematiske metoder 1–3, og UiA har Matematikk 1–4. Bare det første emnet i hvert løp er koblet her; de videregående matematikkemnene har ingen NMBU-parallell.',
        links: [
          { entryId: 'nmbu_fornybar', emnekoder: ['MATH100-1'], merknad: 'Brukerkurs i matematikk, 10 sp.' },
          { entryId: 'hvl_fornybar', emnekoder: ['FE404-1', 'MA415-1'], merknad: 'Matematikk for fornybar energi og Matematikk brukeremne.' },
          { entryId: 'ntnu_ing_fornybar_trondheim', emnekoder: ['IMAT1002-1', 'IMAT1001-1'], merknad: 'Matematikk for ingeniørfag 1; IMAT1001 Matematiske metoder 1 er forgjengeren.' },
          { entryId: 'ntnu_ing_fornybar_gjovik', emnekoder: ['IMAG1002-1', 'IMAG1001-1'], merknad: 'Gjøvik-versjonen av de samme emnene.' },
          { entryId: 'ntnu_ing_fornybar_alesund', emnekoder: ['IMAA1002-1', 'IMAA1001-1'], merknad: 'Ålesund-versjonen av de samme emnene.' },
          { entryId: 'uia_ing_fornybar', emnekoder: ['MA-178-G'], merknad: 'Matematikk 1.' },
          { entryId: 'uit_fornybar', emnekoder: ['MAT-1050-1', 'MAT-1507-1'], merknad: 'Matematikk 1 for ingeniører, to kodeversjoner; få kandidater.' },
        ],
      },
      {
        id: 'fysikk', label: 'Fysikk', kategori: 'Realfag',
        desc: 'Innføringsemne i fysikk: mekanikk, energi, varme og elektromagnetisme.',
        note: 'NMBUs FYS100 Fysikk og natur er et anvendt emne rettet mot miljø- og naturfag, mens ingeniørløpene har ordinær ingeniørfysikk. NTNUs IFYKJ-emner (10 sp) kombinerer fysikk og kjemi og er forgjengerne til de rene fysikkemnene.',
        links: [
          { entryId: 'nmbu_fornybar', emnekoder: ['FYS100-1'], merknad: 'Fysikk og natur, 10 sp.' },
          { entryId: 'hvl_fornybar', emnekoder: ['FY400-1'], merknad: 'Innføring i fysikk.' },
          { entryId: 'ntnu_ing_fornybar_trondheim', emnekoder: ['IFYT1002-1', 'IFYKJT1001-1'], merknad: 'Fysikk; IFYKJT1001 Fysikk/kjemi er forgjengeren.' },
          { entryId: 'ntnu_ing_fornybar_gjovik', emnekoder: ['IFYG1002-1', 'IFYKJG1001-1'], merknad: 'Gjøvik-versjonen av de samme emnene.' },
          { entryId: 'ntnu_ing_fornybar_alesund', emnekoder: ['IFYA1002-1', 'IFYKJA1001-1'], merknad: 'Ålesund-versjonen av de samme emnene.' },
          { entryId: 'uia_ing_fornybar', emnekoder: ['FYS128-G'] },
          { entryId: 'uit_fornybar', emnekoder: ['FYS-2500-1'], merknad: 'Fysikk for ingeniører; få kandidater.' },
        ],
      },
      {
        id: 'fornybare-energikilder', label: 'Fornybare energikilder og -teknologier', kategori: 'Energi',
        desc: 'Oversikt over energikildene – sol, vind, vann, bio og varme – og teknologiene som utnytter dem.',
        note: 'NMBU samler hele oversikten i ett emne (FORNY200, 10 sp), mens ingeniørløpene har egne emner per energikilde. Sol, vind og vannkraft er derfor ikke satt opp som egne emnetyper: NTNUs FENT2021 Solenergi, FENT2321 Vindenergi og TVM4165 Vannkraftverk, UiAs ENE241 Solenergisystemer, ENE243 Vindkraft og ENE240 Vannkraft og UiTs FYS-2024 og FYS-2023 er koblet inn her i stedet.',
        links: [
          { entryId: 'nmbu_fornybar', emnekoder: ['FORNY200-1', 'FORN200-1'], merknad: 'Fornybare energikilder og -teknologier; FORN200 Energisystemer og produksjonsteknologier er den eldre kodeversjonen.' },
          { entryId: 'hvl_fornybar', emnekoder: ['FE407-1', 'FE405-1'], merknad: 'Fornybar energiteknologi og ressursvurdering og Grunnleggende energikonsepter.' },
          { entryId: 'ntnu_ing_fornybar_trondheim', emnekoder: ['FENT1101-1', 'FENT1102-1', 'FENT1001-1', 'FENT2021-1', 'FENT2321-1', 'TVM4165-1'], merknad: 'Fornybar energi grunnkurs 1 og 2 (FENT1001 er 10 sp-forgjengeren), Solenergi, Vindenergi og design av vindturbin og Vannkraftverk og vassdragsteknikk.' },
          { entryId: 'ntnu_ing_fornybar_gjovik', emnekoder: ['FENG1101-1', 'FENG1102-1', 'FENG1001-1', 'FENG2021-1'], merknad: 'Gjøvik-versjonene: Fornybar energi grunnkurs 1 og 2 og Solenergi.' },
          { entryId: 'ntnu_ing_fornybar_alesund', emnekoder: ['FENA1101-1', 'FENA1102-1', 'FENA1001-1', 'FENA2021-1'], merknad: 'Ålesund-versjonene: Fornybar energi grunnkurs 1 og 2 og Solenergi.' },
          { entryId: 'uia_ing_fornybar', emnekoder: ['ENE111-G', 'ENE109-G', 'ENE241-G', 'ENE243-G', 'ENE240-G'], merknad: 'Fornybar energi, Energilab, Solenergisystemer, Vindkraft og Vannkraft.' },
          { entryId: 'uit_fornybar', emnekoder: ['FYS-2024-1', 'FYS-2023-1'], merknad: 'Solar and wind energy systems og Introduksjon til vannkraft; få kandidater.' },
        ],
      },
      {
        id: 'energi-miljo-samfunn', label: 'Energi, miljø og samfunn', kategori: 'Energi',
        desc: 'Energiomstillingen i et samfunnsperspektiv: energipolitikk, bærekraft og teknologiens rolle.',
        note: 'Dette er innfallsporten til studiet ved NMBU, HVL, UiA og UiT. NTNUs fornybar energi-ingeniør har ikke noe eget samfunnsemne; der ligger systemperspektivet i INGT2300 Ingeniørfaglig systemtenkning, som er et generelt ingeniøremne og ikke er koblet.',
        links: [
          { entryId: 'nmbu_fornybar', emnekoder: ['FORNY100-1', 'FORN100-1', 'ECN180-1'], merknad: 'Energi, miljø og samfunn (FORN100 er den eldre kodeversjonen) og Globale utfordringer I. Økonomi og bærekraft.' },
          { entryId: 'hvl_fornybar', emnekoder: ['FE410-1', 'FE401-1', 'FE408-1'], merknad: 'Teknologi, innovasjon og samfunn, Miljø- og energipolitikk og Bærekraftig energiomstilling.' },
          { entryId: 'uia_ing_fornybar', emnekoder: ['ING101-G', 'ING200-G'], merknad: 'Teknologi, miljø og bærekraft og Teknologi, bærekraft og samfunn i et systemperspektiv.' },
          { entryId: 'uit_fornybar', emnekoder: ['FYS-1008-1'], merknad: 'Fornybar energi, bærekraft og samfunn; få kandidater.' },
        ],
      },
      {
        id: 'energisystemanalyse', label: 'Energibruk og energisystemanalyse', kategori: 'Energi',
        desc: 'Analyse av energisystemer: energibalanser, energibruk i bygg og industri og modellering av systemene.',
        note: 'UiA og UiT har ikke noe eget systemanalyseemne. HVLs FE411 Energisystemer er nærmest NMBUs FORNY260, mens NTNUs FENT2020 er et rent analyseemne i tredje studieår.',
        links: [
          { entryId: 'nmbu_fornybar', emnekoder: ['FORNY260-1'], merknad: 'Energibruk og energisystemanalyse.' },
          { entryId: 'hvl_fornybar', emnekoder: ['FE411-1', 'FE402-1'], merknad: 'Energisystemer og Anvendte øvinger i energiomstilling.' },
          { entryId: 'ntnu_ing_fornybar_trondheim', emnekoder: ['FENT2020-1'], merknad: 'Energisystem analyse.' },
          { entryId: 'ntnu_ing_fornybar_gjovik', emnekoder: ['FENG2020-1'] },
          { entryId: 'ntnu_ing_fornybar_alesund', emnekoder: ['FENA2020-1'] },
        ],
      },
      {
        id: 'kraftnett-energilagring', label: 'Kraftnett, energidistribusjon og energilagring', kategori: 'Energi',
        desc: 'Overføring og distribusjon av energi, nettilknytning av fornybar produksjon, fjernvarme og lagring av energi.',
        note: 'NMBU dekker både distribusjon og lagring i ett emne på 5 sp, mens NTNU har to til tre emner og UiA tre. HVL og UiT har ingen emner på dette feltet. Den elektrotekniske grunnlagsdelen (kretsteknikk, elektriske maskiner) har NMBU ikke og er ikke koblet.',
        links: [
          { entryId: 'nmbu_fornybar', emnekoder: ['FORNY240-1', 'FORN240-1'], merknad: 'Energidistribusjon og -lagringssystemer; FORN240 er den eldre kodeversjonen.' },
          { entryId: 'ntnu_ing_fornybar_trondheim', emnekoder: ['FENT2001-1', 'FENT2011-1', 'FENT2314-1'], merknad: 'Elektriske energisystemer og fjernvarme og Energilagring 1 og 2.' },
          { entryId: 'ntnu_ing_fornybar_gjovik', emnekoder: ['FENG2001-1', 'FENG2011-1'], merknad: 'Gjøvik-versjonene av Elektriske energisystemer og fjernvarme og Energilagring 1.' },
          { entryId: 'ntnu_ing_fornybar_alesund', emnekoder: ['FENA2001-1', 'FENA2011-1', 'FENA2314-1', 'FENA2101-1'], merknad: 'Ålesund-versjonene, i tillegg til Elektriske energisystemer og mikrogrid.' },
          { entryId: 'uia_ing_fornybar', emnekoder: ['ENE229-G', 'ENE231-G', 'ENE246-G'], merknad: 'Fornybar energi i kraftnettet, Lavspennings- og høgspenningsteknologi og Batterier.' },
        ],
      },
      {
        id: 'bioenergi', label: 'Bioenergi', kategori: 'Energi',
        desc: 'Biomasse som energiressurs: råstoff, forbrenning, biodrivstoff og verdikjedene.',
        note: 'Alle utenom HVL har et eget bioenergiemne. NTNU har emnet i Trondheim og på Gjøvik, men ikke i Ålesund. UiTs emne er engelskspråklig og har få kandidater.',
        links: [
          { entryId: 'nmbu_fornybar', emnekoder: ['FORNY210-1'], merknad: 'Bioenergi - teknologi og verdikjeder.' },
          { entryId: 'ntnu_ing_fornybar_trondheim', emnekoder: ['FENT2022-1'] },
          { entryId: 'ntnu_ing_fornybar_gjovik', emnekoder: ['FENG2022-1'] },
          { entryId: 'uia_ing_fornybar', emnekoder: ['ENE239-G'] },
          { entryId: 'uit_fornybar', emnekoder: ['KJE-2006-1'], merknad: 'Introduction to modern bioenergy; få kandidater.' },
        ],
      },
      {
        id: 'livslopsvurdering', label: 'Livsløpsvurdering og miljøeffekter', kategori: 'Miljø',
        desc: 'Livsløpsanalyse (LCA) av energi- og avfallssystemer og vurdering av miljøeffektene ved energiteknologi.',
        note: 'HVL og UiA har ikke noe eget LCA-emne; miljøvurderingen ligger der inne i bærekraftsemnene. NMBUs emne er på 10 sp mot NTNUs 7,5 sp.',
        links: [
          { entryId: 'nmbu_fornybar', emnekoder: ['FORNY220-1', 'FORN220-1'], merknad: 'Livsløpsvurdering - miljøeffekter av energi- og avfallssystemer; FORN220 er den eldre kodeversjonen.' },
          { entryId: 'ntnu_ing_fornybar_trondheim', emnekoder: ['FENT2023-1'], merknad: 'Livsløpsvurderinger av energisystem.' },
          { entryId: 'ntnu_ing_fornybar_gjovik', emnekoder: ['FENG2023-1'] },
          { entryId: 'ntnu_ing_fornybar_alesund', emnekoder: ['FENA2023-1'] },
          { entryId: 'uit_fornybar', emnekoder: ['TEK-2007-1'], merknad: 'Sustainable Design and Life Cycle Assessments; få kandidater.' },
        ],
      },
      {
        id: 'energiokonomi', label: 'Energiøkonomi og energimarkeder', kategori: 'Økonomi',
        desc: 'Kraftmarkedet, prisdannelse, virkemidler og lønnsomhetsvurdering av energiprosjekter.',
        note: 'Økonomi er NMBUs sterkeste side i denne gruppa, med fire emner på til sammen 25 sp. HVL har ett energiøkonomiemne og UiA ett kombinert økonomi- og innovasjonsemne. NTNU og UiT har ingen økonomiemner i fornybarløpene.',
        links: [
          { entryId: 'nmbu_fornybar', emnekoder: ['FORNY150-1', 'FORNY230-1', 'FORN230-1', 'FORN120-1', 'ECN101-1'], merknad: 'Investeringsanalyse av energiprosjekter, Energimarkeder og virkemidler (FORN230 Energimarkeder og energipolitikk er den eldre kodeversjonen), Grunnleggende energiøkonomi og Samfunnsøkonomi for miljø og utvikling.' },
          { entryId: 'hvl_fornybar', emnekoder: ['FE406-1'], merknad: 'Energiøkonomi.' },
          { entryId: 'uia_ing_fornybar', emnekoder: ['ING201-G'], merknad: 'Økonomi og innovasjon.' },
        ],
      },
      {
        id: 'klima', label: 'Klimaendringer og klimatilpasning', kategori: 'Miljø',
        desc: 'Klimasystemet, menneskeskapte klimaendringer og tilpasning til dem.',
        note: 'Bare NMBU og HVL har et eget klimaemne; hos NTNU, UiA og UiT ligger klimastoffet inne i energi- og bærekraftsemnene. HVLs GE483 Climate Change er engelskspråklig og deles med geologibachelorene i Sogndal.',
        links: [
          { entryId: 'nmbu_fornybar', emnekoder: ['FYS140-1'], merknad: 'Klimaendringer, bærekraft og tilpasninger.' },
          { entryId: 'hvl_fornybar', emnekoder: ['GE483-1'], merknad: 'Climate Change.' },
        ],
      },
      {
        id: 'statistikk', label: 'Statistikk', kategori: 'Metode',
        desc: 'Sannsynlighetsregning, statistisk inferens og dataanalyse.',
        note: 'HVL dekker statistikk inne i metodekurset FE409 Metodekurs for fornybar energi, som også omfatter oppgaveskriving, og er derfor ikke koblet. UiTs to statistikkemner har for få rapporterte kandidater til å kobles.',
        links: [
          { entryId: 'nmbu_fornybar', emnekoder: ['STAT100-1'] },
          { entryId: 'ntnu_ing_fornybar_trondheim', emnekoder: ['ISTT1002-1'] },
          { entryId: 'ntnu_ing_fornybar_gjovik', emnekoder: ['ISTG1002-1'] },
          { entryId: 'ntnu_ing_fornybar_alesund', emnekoder: ['ISTA1002-1'] },
          { entryId: 'uia_ing_fornybar', emnekoder: ['MA-223-G'], merknad: 'Statistikk.' },
        ],
      },
      {
        id: 'programmering', label: 'Programmering og databehandling', kategori: 'Metode',
        desc: 'Innføring i programmering og verktøy for å behandle og analysere data.',
        note: 'Her er forskjellen stor. Ingeniørløpene har programmering som obligatorisk emne, mens NMBU-studentene i praksis bruker BUS133 Excel - fra data til informasjon; INF120 Programmering og databehandling er valgemne med få kandidater. HVL har ikke programmering i fornybarløpet.',
        links: [
          { entryId: 'nmbu_fornybar', emnekoder: ['BUS133-1', 'INF120-1'], merknad: 'Excel - fra data til informasjon er det mest brukte databehandlingsemnet; INF120 Programmering og databehandling er valgemne med få kandidater.' },
          { entryId: 'ntnu_ing_fornybar_trondheim', emnekoder: ['INGT1002-1'], merknad: 'Programmering, numerikk og sikkerhet.' },
          { entryId: 'ntnu_ing_fornybar_gjovik', emnekoder: ['INGG1002-1'] },
          { entryId: 'ntnu_ing_fornybar_alesund', emnekoder: ['INGA1002-1'] },
          { entryId: 'uia_ing_fornybar', emnekoder: ['ING100-G'], merknad: 'Programmering og IKT-sikkerhet.' },
          { entryId: 'uit_fornybar', emnekoder: ['INF-0101-1', 'INF-1049-1'], merknad: 'Innføring i programmering og Introduksjon til beregningsorientert programmering; få kandidater.' },
        ],
      },
      {
        id: 'arealplanlegging-gis', label: 'GIS, arealplanlegging og konsekvensutredning', kategori: 'Forvaltning',
        desc: 'Kart- og GIS-verktøy, arealplanprosesser og konsekvensutredning av naturinngrep fra energiutbygging.',
        note: 'Dette skiller de to tverrfaglige programmene fra ingeniørutdanningene: verken NTNU, UiA eller UiT har plan- eller GIS-emner i fornybarløpene. HVL har tre planemner og deler dem med geologibacheloren i Sogndal.',
        links: [
          { entryId: 'nmbu_fornybar', emnekoder: ['LAD102-1', 'MINA250-1', 'NATF260-1', 'JUS220-1'], merknad: 'GIS - praktisk introduksjon, Tverrfaglig konsekvensanalyse (NATF260 er den eldre kodeversjonen) og Miljøforvaltningsrett.' },
          { entryId: 'hvl_fornybar', emnekoder: ['GE413-1', 'PL412-2', 'PL417-1', 'PL418-1', 'PL433-1'], merknad: 'Kartlære og GIS, Landskapsinngrep, Arealplanlegging, Reguleringsplanlegging og Innføring i arealplanlegging.' },
        ],
      },
      {
        id: 'okologi-natur', label: 'Økologi og naturkunnskap', kategori: 'Økologi og natur',
        desc: 'Grunnleggende økologi og kunnskap om norsk natur som bakgrunn for å vurdere naturinngrep.',
        note: 'Bare de to tverrfaglige programmene har økologi. NMBUs ECOL100 er obligatorisk innføringsemne; ECOL200 Generell økologi og NATF200 Vern og forvaltning av norsk natur er valgemner med færre kandidater.',
        links: [
          { entryId: 'nmbu_fornybar', emnekoder: ['ECOL100-1', 'ECOL200-1', 'NATF200-1'], merknad: 'Grunnleggende økologi, Generell økologi og Vern og forvaltning av norsk natur.' },
          { entryId: 'hvl_fornybar', emnekoder: ['BI445-3'], merknad: 'Økologi grunnkurs.' },
        ],
      },
    ],
  },
  ...
  {
    groupId: 'miljonatur',
    note: 'NMBUs bachelor i miljø og naturressurser er et lite program, og DBH har svært få rapporterte kandidater per emne i 2024 og 2025 (de fleste emnene har null). Utvalget av NMBU-emner er derfor gjort på summen av kandidater i hele perioden 2021–2025, ikke på de to siste årene slik som i de andre gruppene; flere av koblingene hviler på 5–40 kandidater samlet over fem år og må leses med varsomhet. Konkurrentene er geofagsbachelorer, og det gir to systematiske skjevheter. For det første har NMBU en jordfaglig og biologisk del (JORD100/JORD101 Jordlære, JORD210 GIS og dynamisk modellering i jord, BOT100 Plantediversitet, ZOOL100 Generell zoologi, BIO130 Generell mikrobiologi, VANN210 Ferskvannsøkologi) som ingen av geologiprogrammene har, og disse er derfor ikke satt opp som emnetyper. For det andre har geologiprogrammene tunge emner i strukturgeologi, sedimentologi, mineralogi, petrologi og geofysikk som NMBU ikke har. Klima er heller ikke satt opp som emnetype: HVLs GE483 Climate Change og UiBs GEOV222 Paleoklimatologi har ingen parallell i NMBU-programmet. UiOs bachelor i klima, miljø og menneske er utelatt fordi DBH bare har rapportert tre emner for programmet, som startet opp i 2025.',
    courseTypes: [
      {
        id: 'geologi-innforing', label: 'Geologi, innføring', kategori: 'Geofag',
        desc: 'Jordas oppbygning og utvikling, bergartene, platetektonikk og de geologiske grunnprosessene.',
        note: 'Alle fem programmene har et innføringsemne i geologi, men vekten er helt ulik: NMBU har ett emne på 10 sp, mens geologibachelorene har flere innføringsemner og bygger hele graden videre på dem.',
        links: [
          { entryId: 'nmbu_miljonatur', emnekoder: ['GEO100-1'], merknad: 'Geologi, 10 sp.' },
          { entryId: 'uio_geologi_geografi', emnekoder: ['GEO1100-1', 'GEO1110-1'], merknad: 'Jordens utvikling og Jordens indre og ytre prosesser.' },
          { entryId: 'uib_geovitenskap', emnekoder: ['GEOV101-0', 'GEOV102-0'], merknad: 'Innføring i geologi og Ekskursjoner og øvelser i geologi.' },
          { entryId: 'ntnu_geologi', emnekoder: ['TGB4100-1', 'TGB4112-1', 'GEOL1001-1'], merknad: 'Geologi innføring, Norges geologi og georessurser og Historisk geologi og paleontologi.' },
          { entryId: 'hvl_geologi_geofare', emnekoder: ['GE406-1'], merknad: 'Geologi grunnkurs.' },
        ],
      },
      {
        id: 'kvartaergeologi', label: 'Kvartærgeologi og landformer', kategori: 'Geofag',
        desc: 'Løsmasser, isbreenes avsetninger, landformdannelse og paleoklima i kvartærtiden.',
        note: 'UiO og NTNU har ikke egne kvartærgeologiemner på bachelornivå. NMBUs tre emner er små (5–10 sp) og har til sammen bare 7–10 kandidater i femårsperioden, så tallene er usikre.',
        links: [
          { entryId: 'nmbu_miljonatur', emnekoder: ['GEO210-1', 'GEO211-1', 'GEO250-1'], merknad: 'Kvartærgeologi, Kvartærgeologisk feltkurs og Jord og geologi i landskapet; få kandidater.' },
          { entryId: 'uib_geovitenskap', emnekoder: ['GEOV110-0', 'GEOV225-0', 'GEOV229-0'], merknad: 'Innføring i eksogene prosesser og paleoklima, Feltkurs i kvartærgeologi og paleoklima og Geomorfologi.' },
          { entryId: 'hvl_geologi_geofare', emnekoder: ['GE486-1'], merknad: 'Glasialgeologi.' },
        ],
      },
      {
        id: 'hydrologi', label: 'Hydrologi og hydrogeologi', kategori: 'Geofag',
        desc: 'Vannets kretsløp, avrenning, grunnvann og vannressursforvaltning.',
        note: 'Vannfaget er NMBUs sterkeste side i denne gruppa: programmet har fire emner på til sammen 30 sp, mot ett emne hos NTNU og HVL. UiO og UiB har ikke hydrologi eller hydrogeologi på bachelornivå.',
        links: [
          { entryId: 'nmbu_miljonatur', emnekoder: ['VANN200-1', 'GEO220-1', 'GEO221-1', 'VANN220-1'], merknad: 'Hydrologi, Hydrogeologi med feltkurs og Vannressurser og vannforsyning.' },
          { entryId: 'ntnu_geologi', emnekoder: ['TGB4205-1'], merknad: 'Hydrogeologi.' },
          { entryId: 'hvl_geologi_geofare', emnekoder: ['GE482-1'], merknad: 'Hydrogeologi.' },
        ],
      },
      {
        id: 'kjemi', label: 'Kjemi', kategori: 'Realfag',
        desc: 'Generell kjemi med atomstruktur, binding, likevekt og syre-base, og uorganisk kjemi.',
        note: 'NMBU har mest kjemi (20 sp fordelt på generell og uorganisk kjemi), fordi miljøkjemien er en bærebjelke i programmet. HVL har ikke kjemi. NTNUs generelle kjemi finnes i fire kodeversjoner i perioden, med ulikt omfang (KJ1000 og KJ1002 er 15 sp-versjonene).',
        links: [
          { entryId: 'nmbu_miljonatur', emnekoder: ['KJM100-1', 'KJM120-1'], merknad: 'Generell kjemi og Uorganisk kjemi.' },
          { entryId: 'uio_geologi_geografi', emnekoder: ['KJM1101-1'], merknad: 'Generell kjemi.' },
          { entryId: 'uib_geovitenskap', emnekoder: ['KJEM109-0', 'KJEM110-0', 'KJEM100-0'], merknad: 'Kjemi grunnkurs, Kjemi og energi og Kjemi i naturen.' },
          { entryId: 'ntnu_geologi', emnekoder: ['KJ1004-1', 'KJ1002-1', 'KJ1001-1', 'KJ1000-1'], merknad: 'Fire kodeversjoner av generell kjemi i perioden.' },
        ],
      },
      {
        id: 'miljokjemi', label: 'Forurensning og miljøkjemi', kategori: 'Miljø',
        desc: 'Miljøgifter og forurensning i jord, vann og luft, og kjemiske prosesser i naturmiljøet.',
        note: 'Dette er kjernen i NMBU-programmet, men bare en randsone hos geologibachelorene: UiOs GEO3100 Miljøgeologi og UiBs GEOV243 Miljøgeokjemi er valgemner med få kandidater. NTNUs KJ2072 Naturmiljøkjemi og TGB4270 om miljøaspekter ved mineralproduksjon har for få rapporterte kandidater til å kobles. MINA200 er den eldre kodeversjonen av MILJØ200.',
        links: [
          { entryId: 'nmbu_miljonatur', emnekoder: ['MILJØ200-1', 'MINA200-1'], merknad: 'Forurensning og miljø; MINA200 er den eldre kodeversjonen.' },
          { entryId: 'uio_geologi_geografi', emnekoder: ['GEO3100-1'], merknad: 'Miljøgeologi; valgemne med få kandidater.' },
          { entryId: 'uib_geovitenskap', emnekoder: ['GEOV243-0'], merknad: 'Miljøgeokjemi; valgemne med få kandidater.' },
        ],
      },
      {
        id: 'gis', label: 'GIS og kartlegging', kategori: 'Metode',
        desc: 'Kartgrunnlag, geografiske informasjonssystemer og romlig modellering av miljø- og geodata.',
        note: 'UiOs GIS-emne GEO3460 har nesten ingen rapporterte kandidater i perioden og er derfor ikke koblet. NMBUs JORD210 er et modelleringsemne som går lenger enn innføringsemnet LAD102.',
        links: [
          { entryId: 'nmbu_miljonatur', emnekoder: ['LAD102-1', 'JORD210-1'], merknad: 'GIS - praktisk introduksjon og GIS og dynamisk modellering i jord.' },
          { entryId: 'uib_geovitenskap', emnekoder: ['GEOV205-0'], merknad: 'Geografiske informasjonssystem: Teori og praksis.' },
          { entryId: 'ntnu_geologi', emnekoder: ['TBA4240-1'], merknad: 'Geografisk informasjonsbehandling 1, grunnkurs.' },
          { entryId: 'hvl_geologi_geofare', emnekoder: ['GE413-1'], merknad: 'Kartlære og GIS.' },
        ],
      },
      {
        id: 'statistikk', label: 'Statistikk', kategori: 'Metode',
        desc: 'Sannsynlighetsregning, statistisk inferens og dataanalyse.',
        note: 'Alle fem har et statistikkemne, men UiBs to emner er valgemner for geovitenskapsstudentene og har få rapporterte kandidater. NTNUs ST0103 er brukerkurset for realfagsstudenter og har langt flere kandidater enn geologiprogrammet alene.',
        links: [
          { entryId: 'nmbu_miljonatur', emnekoder: ['STAT100-1'] },
          { entryId: 'uio_geologi_geografi', emnekoder: ['STK1000-1'], merknad: 'Innføring i anvendt statistikk.' },
          { entryId: 'uib_geovitenskap', emnekoder: ['STAT110-0', 'STAT101-0'], merknad: 'Grunnkurs i statistikk og Elementær statistikk; valgemner med få kandidater.' },
          { entryId: 'ntnu_geologi', emnekoder: ['ST0103-1'], merknad: 'Brukerkurs i statistikk.' },
          { entryId: 'hvl_geologi_geofare', emnekoder: ['ME420-4'], merknad: 'Statistikk.' },
        ],
      },
      {
        id: 'matematikk', label: 'Matematikk', kategori: 'Realfag',
        desc: 'Kalkulus og lineær algebra på brukerkursnivå for natur- og geofag.',
        note: 'Nivåforskjellene er store. NMBU, NTNU og HVL har brukerkurs på ett eller to emner, UiO har to anvendelsesrettede emner (MAT1050/MAT1060), mens UiB har både brukerkurset MAT101 og det tyngre MAT111 Grunnkurs i matematikk I. NMBUs MATH100 har få rapporterte kandidater fra dette programmet.',
        links: [
          { entryId: 'nmbu_miljonatur', emnekoder: ['MATH100-1'], merknad: 'Brukerkurs i matematikk, 10 sp.' },
          { entryId: 'uio_geologi_geografi', emnekoder: ['MAT1050-1', 'MAT1060-1'], merknad: 'Matematikk for anvendelser 1 og 2.' },
          { entryId: 'uib_geovitenskap', emnekoder: ['MAT101-0', 'MAT111-0'], merknad: 'Brukerkurs i matematikk I og Grunnkurs i matematikk I.' },
          { entryId: 'ntnu_geologi', emnekoder: ['MA0001-1', 'MA0002-1'], merknad: 'Brukerkurs i matematikk A og B.' },
          { entryId: 'hvl_geologi_geofare', emnekoder: ['MA414-3'], merknad: 'Matematikk naturfag.' },
        ],
      },
      {
        id: 'fysikk', label: 'Fysikk', kategori: 'Realfag',
        desc: 'Innføringsemne i fysikk: mekanikk, energi og fysiske prosesser i naturen.',
        note: 'UiB har det tyngste emnet (PHYS111 Mekanikk 1), mens NMBUs FYS100 Fysikk og natur er et anvendt emne rettet mot miljø- og naturfag. NTNU har både brukerkurset FY0001 og det geofaglige TPG4100 Fysikk og geofysikk.',
        links: [
          { entryId: 'nmbu_miljonatur', emnekoder: ['FYS100-1'], merknad: 'Fysikk og natur, 10 sp.' },
          { entryId: 'uio_geologi_geografi', emnekoder: ['FYS1001-1'], merknad: 'Innføring i fysikk.' },
          { entryId: 'uib_geovitenskap', emnekoder: ['PHYS111-0'], merknad: 'Mekanikk 1.' },
          { entryId: 'ntnu_geologi', emnekoder: ['FY0001-1', 'TPG4100-1'], merknad: 'Brukerkurs i fysikk og Fysikk og geofysikk.' },
          { entryId: 'hvl_geologi_geofare', emnekoder: ['FY400-1'], merknad: 'Innføring i fysikk.' },
        ],
      },
      {
        id: 'miljoforvaltning', label: 'Miljøforvaltning og arealplanlegging', kategori: 'Forvaltning',
        desc: 'Forvaltning av naturressurser, arealplanlegging og tverrfaglig konsekvensutredning av inngrep.',
        note: 'UiO og NTNU har ingen forvaltnings- eller planemner i geologibachelorene. HVL har mest, med tre planemner, fordi programmet er rettet mot geofare og arealbruk. UiBs GEO-SD330 Natural Resources Management er et valgemne fra utviklingsstudiene.',
        links: [
          { entryId: 'nmbu_miljonatur', emnekoder: ['MINA250-1', 'NATF260-1', 'NATF200-1'], merknad: 'Tverrfaglig konsekvensanalyse (NATF260 er den eldre kodeversjonen) og Vern og forvaltning av norsk natur.' },
          { entryId: 'uib_geovitenskap', emnekoder: ['GEO-SD330-0'], merknad: 'Natural Resources Management; valgemne.' },
          { entryId: 'hvl_geologi_geofare', emnekoder: ['PL433-1', 'PL417-1', 'PL418-1'], merknad: 'Innføring i arealplanlegging, Arealplanlegging og Reguleringsplanlegging.' },
        ],
      },
      {
        id: 'miljo-baerekraft-innforing', label: 'Miljø og bærekraft, innføring', kategori: 'Miljø',
        desc: 'Bredt innføringsemne om miljøutfordringer, naturressurser og bærekraft.',
        note: 'Dette er den løseste koblingen i gruppa. NMBUs MINA100 er programmets eget innføringsemne i miljø og naturressurser, mens NTNUs BI2081 Natur, miljø og bærekraft er et bredt emne fra biologifagmiljøet som geologistudentene tar som valgemne. UiO, UiB og HVL har ingen tilsvarende innføringsemne.',
        links: [
          { entryId: 'nmbu_miljonatur', emnekoder: ['MINA100-1'], merknad: 'Innføring i miljø og naturressurser, 10 sp.' },
          { entryId: 'ntnu_geologi', emnekoder: ['BI2081-1'], merknad: 'Natur, miljø og bærekraft; valgemne.' },
        ],
      },
    ],
  },
  ...
  {
    groupId: 'okologi',
    note: 'Gruppa rommer to utdanningsfamilier. NMBUs bachelor i økologi og naturforvaltning, INNs utmarksforvaltning på Evenstad, Nords naturforvaltning på Steinkjer og USNs natur- og miljøforvaltning i Bø er profesjonsrettede naturforvaltningsbachelorer der biologi kombineres med forvaltning, juss, GIS og arealplanlegging. Biologibachelorene ved UiT og UiA er rene realfagsløp: de er sterke på økologi, zoologi, botanikk, kjemi og statistikk, men har verken forvaltningsemner, GIS eller arealplanlegging, og er derfor bare koblet på realfagsdelen. Både USN og INN la om studieplanene sine i perioden; de gamle emnekodene (USNs firesifrede koder og INNs 6EV-koder) er koblet sammen med de nye, slik at tidsseriene henger sammen. To fag som konkurrentene har, er ikke satt opp som emnetyper fordi NMBU-programmet ikke har dem: evolusjon og genetikk (Nord BIO140, USN NM103/NM105, UiT BIO-1008/BIO-2018, UiA BIO113/BIO111, INN 6AE124) og celle- og molekylærbiologi (Nord BIO1009, USN NM105, UiT MBI-1002, UiA BIO111). Examen philosophicum er heller ikke satt opp: NMBU, Nord, UiT og UiA har det, men INN og USN har ikke noe tilsvarende emne.',
    courseTypes: [
      {
        id: 'okologi', label: 'Generell økologi', kategori: 'Økologi og natur',
        desc: 'Grunnleggende økologi: populasjoner, samfunn, økosystemer, energistrøm og biologisk mangfold.',
        note: 'Omfanget spenner fra 5 sp (NMBUs innføringsemne ECOL100) til 20 sp (UiTs BIO-2017). Alle seks programmene har økologi som bærebjelke, og dette er den sterkeste koblingen i gruppa. USNs NM103 Økologi og evolusjon (15 sp) slår sammen økologi og evolusjon og erstattet 4105 Økologi ved studieplanomleggingen.',
        links: [
          { entryId: 'nmbu_okologi', emnekoder: ['ECOL200-1', 'ECOL100-1'], merknad: 'ECOL200 Generell økologi (10 sp) er hovedemnet; ECOL100 Grunnleggende økologi er innføringsemnet.' },
          { entryId: 'inn_utmarksforvaltning', emnekoder: ['UTM1133-1', '6EV133-1'], merknad: 'Økologi; 6EV133 Økologi og mangfold (15 sp) er forgjengeren.' },
          { entryId: 'nord_naturforvaltning', emnekoder: ['BIO201-1', 'ØKO2002-1'], merknad: 'Økologi og Populasjonsøkologi; ØKO2002 kom inn med den nye studieplanen i 2025.' },
          { entryId: 'usn_naturmiljoforvaltning', emnekoder: ['NM103-1', '4105-1', 'NF211-1'], merknad: 'Økologi og evolusjon (15 sp), forgjengeren 4105 Økologi og fordypningsemnet Populasjons- og adferdsøkologi.' },
          { entryId: 'uit_biologi', emnekoder: ['BIO-2017-1', 'BIO-1011-1'], merknad: 'Økologi (20 sp) og Økologi og biologisk mangfold.' },
          { entryId: 'uia_biologi', emnekoder: ['BIO206-1'] },
        ],
      },
      {
        id: 'zoologi', label: 'Zoologi og faunakunnskap', kategori: 'Økologi og natur',
        desc: 'Dyrerikets systematikk, artskunnskap og biologi, med vekt på norsk fauna.',
        note: 'NMBU har klart størst omfang med 20 sp fordelt på tre emner, der ZOOL220 Insekter og edderkoppdyr er et eget entomologiemne som ingen av de andre har. INN dekker artskunnskapen i 6EV132 Norsk fauna.',
        links: [
          { entryId: 'nmbu_okologi', emnekoder: ['ZOOL100-1', 'ZOOL210-1', 'ZOOL220-1'], merknad: 'Generell zoologi, Virveldyr og Insekter og edderkoppdyr.' },
          { entryId: 'inn_utmarksforvaltning', emnekoder: ['6EV132-1'], merknad: 'Norsk fauna.' },
          { entryId: 'nord_naturforvaltning', emnekoder: ['BIO1020-1', 'BIO1012-1'], merknad: 'Zoologisk artslære; BIO1012 Innføring i zoologi er det nye emnet fra 2025.' },
          { entryId: 'usn_naturmiljoforvaltning', emnekoder: ['NM107-1', '4019-1'], merknad: 'Faunistikk; 4019 Zoologi er forgjengeren.' },
          { entryId: 'uit_biologi', emnekoder: ['BIO-1104-1'] },
          { entryId: 'uia_biologi', emnekoder: ['BIO103-1'] },
        ],
      },
      {
        id: 'botanikk', label: 'Botanikk og vegetasjonskunnskap', kategori: 'Økologi og natur',
        desc: 'Planterikets systematikk, artskunnskap og vegetasjonsøkologi.',
        note: 'INNs 6EV130 Vegetasjon og kretsløp har ingen kandidater etter 2023 og er ikke erstattet av et eget botanikkemne; plantekunnskapen der ligger nå inne i SKO1105 Naturgrunnlaget. NMBUs BOT210 Sopp, lav og mose er et kryptogamemne som bare Nord og USN har noe tilsvarende til.',
        links: [
          { entryId: 'nmbu_okologi', emnekoder: ['BOT100-1', 'BOT210-2', 'BOT210-1'], merknad: 'Plantediversitet og Sopp, lav og mose (to kodeversjoner).' },
          { entryId: 'inn_utmarksforvaltning', emnekoder: ['6EV130-1'], merknad: 'Vegetasjon og kretsløp; ingen kandidater etter 2023.' },
          { entryId: 'nord_naturforvaltning', emnekoder: ['BIO2060-1', 'BIO1011-1'], merknad: 'Botanisk artslære; BIO1011 Innføring i botanikk er det nye emnet fra 2025.' },
          { entryId: 'usn_naturmiljoforvaltning', emnekoder: ['NM106-1', '4018-1', 'NF210-1'], merknad: 'Floristikk, forgjengeren 4018 Botanikk og fordypningsemnet Vegetasjonsøkologi.' },
          { entryId: 'uit_biologi', emnekoder: ['BIO-1103-1'] },
          { entryId: 'uia_biologi', emnekoder: ['BIO102-1'] },
        ],
      },
      {
        id: 'naturkartlegging', label: 'Naturtypekartlegging og naturovervåking', kategori: 'Økologi og natur',
        desc: 'Feltbasert kartlegging av naturtyper etter NiN, registrering av arter og overvåking av natur.',
        note: 'Dette er et typisk forvaltningsemne: INN, UiT og UiA har ikke noe eget kartleggingsemne. Nords BIO2310 Naturregistrering er størst med 15 sp.',
        links: [
          { entryId: 'nmbu_okologi', emnekoder: ['BOT270-1'], merknad: 'Kartlegging av natur.' },
          { entryId: 'nord_naturforvaltning', emnekoder: ['BIO2310-1'], merknad: 'Naturregistrering, 15 sp.' },
          { entryId: 'usn_naturmiljoforvaltning', emnekoder: ['NF213-1'], merknad: 'Naturkartlegging og overvåking; nytt emne fra 2025.' },
        ],
      },
      {
        id: 'naturforvaltning', label: 'Naturforvaltning og bevaringsbiologi', kategori: 'Forvaltning',
        desc: 'Vern og forvaltning av natur: verneformer, forvaltningsapparatet, bevaringsbiologi og naturveiledning.',
        note: 'Biologibachelorene ved UiT og UiA har ingen forvaltningsemner og er derfor ikke koblet. INNs to emner er spissere enn de andres: 6EV150 Naturoppsyn handler om oppsyns- og kontrollarbeid og UTM1151 om besøksforvaltning. USNs emner er bevaringsbiologi på engelsk (NM116 avløste 4505).',
        links: [
          { entryId: 'nmbu_okologi', emnekoder: ['NATF100-1', 'NATF200-1'], merknad: 'Innføringskurs i naturforvaltning (10 sp) og Vern og forvaltning av norsk natur.' },
          { entryId: 'inn_utmarksforvaltning', emnekoder: ['6EV150-1', 'UTM1151-1'], merknad: 'Naturoppsyn og Besøksforvaltning og naturveiledning.' },
          { entryId: 'nord_naturforvaltning', emnekoder: ['NAT330-1'], merknad: 'Naturforvaltning, 20 sp.' },
          { entryId: 'usn_naturmiljoforvaltning', emnekoder: ['NM102-1', 'NM116-1', '4505-1'], merknad: 'Bærekraftsmål og bevaringsbiologi og Conservation Biology; 4505 er den gamle koden for Conservation Biology.' },
        ],
      },
      {
        id: 'vilt-og-fiskeforvaltning', label: 'Vilt- og fiskeforvaltning', kategori: 'Forvaltning',
        desc: 'Bestandsforvaltning av vilt og fisk: viltbiologi, jakt, rovvilt, fiskeforvaltning og konflikter mellom mennesker og vilt.',
        note: 'Dette er kjernen i INNs utmarksforvaltning, som har fem emner på til sammen 37,5 sp. NMBU har to emner på 25 sp. UiT og UiA har ingen forvaltningsemner for vilt og fisk og er ikke koblet.',
        links: [
          { entryId: 'nmbu_okologi', emnekoder: ['NATF230-1', 'NATF240-1'], merknad: 'Viltbiologi og forvaltning (15 sp) og Fiskeøkologi og forvaltning (10 sp).' },
          { entryId: 'inn_utmarksforvaltning', emnekoder: ['UTM2140-1', '6EV240-1', 'UTM1140-1', 'UTM1176-1', 'UTM2220-1'], merknad: 'Viltforvaltning (6EV240 er forgjengeren på 15 sp), Wildlife ecology, Large predator ecology and management og Fiskeforvaltning.' },
          { entryId: 'nord_naturforvaltning', emnekoder: ['NAF1000-1', 'BIO1210-1'], merknad: 'Fisk- og viltforvaltning; BIO1210 Fisk- og hjorteviltforvaltning er forgjengeren.' },
          { entryId: 'usn_naturmiljoforvaltning', emnekoder: ['NF212-1', '4208-1', 'NF214-1', 'NM115-1', '4207-1'], merknad: 'Viltøkologi og viltforvaltning (4208 er forgjengeren), Wildlife Conflict Management og Ferskvannsfisk og vannressursforvaltning (4207 er forgjengeren).' },
        ],
      },
      {
        id: 'ferskvannsokologi', label: 'Ferskvannsøkologi', kategori: 'Økologi og natur',
        desc: 'Innsjøers og vassdrags økologi: limnologi, vannkvalitet og ferskvannets organismesamfunn.',
        note: 'Nord og UiT har ikke noe eget ferskvannsemne. UiAs BIO201 Akvatisk økologi dekker både ferskvann og marint miljø og er derfor en svakere kobling. Merk at Nords BIO201 er et helt annet emne (Økologi) – samme emnekode brukes om to ulike emner ved de to institusjonene.',
        links: [
          { entryId: 'nmbu_okologi', emnekoder: ['VANN210-1'], merknad: 'Ferskvannsøkologi, 10 sp.' },
          { entryId: 'inn_utmarksforvaltning', emnekoder: ['UTM1120-1', '6EV120-1'], merknad: 'Ferskvannsøkologi; 6EV120 Ferskvannsfisk og ferskvannsøkologi (15 sp) er forgjengeren.' },
          { entryId: 'usn_naturmiljoforvaltning', emnekoder: ['NM111-1', '4503-1'], merknad: 'Ferskvannsøkologi; 4503 er forgjengeren.' },
          { entryId: 'uia_biologi', emnekoder: ['BIO201-1'], merknad: 'Akvatisk økologi; dekker både ferskvann og marine miljøer.' },
        ],
      },
      {
        id: 'gis', label: 'GIS og geografisk analyse', kategori: 'Metode',
        desc: 'Kartgrunnlag, geografiske informasjonssystemer, datafangst og romlig analyse.',
        note: 'GIS skiller forvaltningsbachelorene fra biologibachelorene: verken UiT eller UiA har GIS-emner. Nord har mest, med fire emner i den nye og gamle studieplanen til sammen.',
        links: [
          { entryId: 'nmbu_okologi', emnekoder: ['LAD102-1'], merknad: 'GIS - praktisk introduksjon, 5 sp.' },
          { entryId: 'inn_utmarksforvaltning', emnekoder: ['6EV153-1', 'SKO2153-1'], merknad: 'Introduksjon til geografiske informasjonssystemer og Geografisk analyse.' },
          { entryId: 'nord_naturforvaltning', emnekoder: ['GEO2011-1', 'GEO220-1', 'GEO1010-1', 'GEO2009-1'], merknad: 'Geografisk informasjonsbehandling (GEO220 er 20 sp-forgjengeren), Kartlære og datafangst og GIS 3D-visualisering.' },
          { entryId: 'usn_naturmiljoforvaltning', emnekoder: ['GIS3000-1', '5708-1'], merknad: 'Geografiske informasjonssystemer; 5708 GIS og kart er forgjengeren.' },
        ],
      },
      {
        id: 'statistikk', label: 'Statistikk og vitenskapelig metode', kategori: 'Metode',
        desc: 'Statistisk analyse, studiedesign og vitenskapelig arbeidsmetode med rapportskriving.',
        note: 'Alle seks programmene har dette. INNs 6EV298 (15 sp) og Nords MA116F kombinerer metode, matematikk og statistikk i samme emne, mens NMBU, USN, UiT og UiA har rene statistikk- eller dataanalyseemner. Nord har i tillegg to rene skrive- og metodeemner (MET2000 og MET1005).',
        links: [
          { entryId: 'nmbu_okologi', emnekoder: ['STAT100-1'] },
          { entryId: 'inn_utmarksforvaltning', emnekoder: ['6EV298-1', '6EV198-1'], merknad: 'Vitenskapelig metode og statistikk; 6EV198 Rapport og analyse er forgjengeren.' },
          { entryId: 'nord_naturforvaltning', emnekoder: ['MA116F-1', 'MET2000-1', 'MET1005-1'], merknad: 'Matematikk/Statistikk for biologer, Innføring i vitenskapelig metode og skriving og Akademisk skriving og metode.' },
          { entryId: 'usn_naturmiljoforvaltning', emnekoder: ['NM110-1', '4013-1'], merknad: 'Anvendt statistikk; 4013 er forgjengeren.' },
          { entryId: 'uit_biologi', emnekoder: ['BIO-2004-1', 'BIO-1007-1'], merknad: 'Studiedesign og dataanalyse i biologi og Kvantitative metoder.' },
          { entryId: 'uia_biologi', emnekoder: ['MA-143-1'], merknad: 'Biostatistikk.' },
        ],
      },
      {
        id: 'kjemi', label: 'Kjemi', kategori: 'Realfag',
        desc: 'Generell kjemi: atomer, binding, likevekt og syre-base, med laboratoriearbeid.',
        note: 'INNs utmarksforvaltning er det eneste programmet uten kjemiemne. Nords BIO101 Kjemi, miljø og forurensning kombinerer kjemi med forurensningslære. UiA har i tillegg organisk kjemi, som de andre ikke har.',
        links: [
          { entryId: 'nmbu_okologi', emnekoder: ['KJM100-1'], merknad: 'Generell kjemi, 10 sp.' },
          { entryId: 'nord_naturforvaltning', emnekoder: ['KJE1000-1', 'BIO101-2'], merknad: 'Grunnleggende kjemi; BIO101 Kjemi, miljø og forurensning er forgjengeren.' },
          { entryId: 'usn_naturmiljoforvaltning', emnekoder: ['NM112-1', '4110-1'], merknad: 'Anvendt kjemi; 4110 er forgjengeren.' },
          { entryId: 'uit_biologi', emnekoder: ['KJE-1001-1'], merknad: 'Introduksjon til kjemi og kjemisk biologi.' },
          { entryId: 'uia_biologi', emnekoder: ['KJ-111-1', 'KJ-213-1'], merknad: 'Generell kjemi og Organisk kjemi.' },
        ],
      },
      {
        id: 'geologi-naturgrunnlag', label: 'Geologi, naturtyper og landskap', kategori: 'Geofag',
        desc: 'Berggrunn, løsmasser, landformer og hvordan geologi og klima setter rammene for naturtypene.',
        note: 'De fire forvaltningsbachelorene har alle et naturgrunnlagsemne, mens biologibachelorene ved UiT og UiA ikke har geologi. INNs SKO1105 Naturgrunnlaget (15 sp) dekker jord, geologi og vegetasjon samlet.',
        links: [
          { entryId: 'nmbu_okologi', emnekoder: ['GEO100-1'], merknad: 'Geologi, 10 sp.' },
          { entryId: 'inn_utmarksforvaltning', emnekoder: ['SKO1105-1', '6EV131-1'], merknad: 'Naturgrunnlaget; 6EV131 Geologi og landformer er forgjengeren.' },
          { entryId: 'nord_naturforvaltning', emnekoder: ['BIO1004-1', 'BIO1010-1'], merknad: 'Naturtyper, klima og geologi; BIO1010 Vegetasjon, klima og geologi er forgjengeren.' },
          { entryId: 'usn_naturmiljoforvaltning', emnekoder: ['NM101-1', '4009-1'], merknad: 'Geologi og landskap; 4009 er forgjengeren.' },
        ],
      },
      {
        id: 'forvaltningsrett', label: 'Forvaltningsrett og miljørett', kategori: 'Forvaltning',
        desc: 'Offentlig saksbehandling, forvaltningsloven og det juridiske rammeverket for natur- og miljøforvaltning.',
        note: 'USN dekker miljøretten inne i arealplanleggingsemnet 4112 Arealplanlegging og miljørett og er derfor koblet under arealplanlegging i stedet. UiT og UiA har ingen juridiske emner.',
        links: [
          { entryId: 'nmbu_okologi', emnekoder: ['JUS201-1'], merknad: 'Offentlig saksbehandling og forvaltningsrett.' },
          { entryId: 'inn_utmarksforvaltning', emnekoder: ['SKO1154-1'], merknad: 'Forvaltningsrett.' },
          { entryId: 'nord_naturforvaltning', emnekoder: ['NAF1001-1', 'NAT203-2'], merknad: 'Rettslære for naturforvaltere; NAT203 Forvaltnings- og miljørett er forgjengeren.' },
        ],
      },
      {
        id: 'arealplanlegging', label: 'Arealplanlegging og konsekvensutredning', kategori: 'Forvaltning',
        desc: 'Plan- og bygningsloven, arealplanprosesser og tverrfaglig konsekvensutredning av naturinngrep.',
        note: 'NMBUs MINA250 er et tverrfaglig konsekvensanalysekurs på 10 sp i siste semester (tidligere kodet NATF260). INN har bare arealforvaltningsdelen, mens Nord og USN har rene arealplanleggingsemner. UiT og UiA har ingen planfag.',
        links: [
          { entryId: 'nmbu_okologi', emnekoder: ['MINA250-1', 'NATF260-1'], merknad: 'Tverrfaglig konsekvensanalyse; NATF260 er den eldre kodeversjonen.' },
          { entryId: 'inn_utmarksforvaltning', emnekoder: ['6EV155-1'], merknad: 'Arealforvaltning.' },
          { entryId: 'nord_naturforvaltning', emnekoder: ['GEO2008-1', 'NAF2000-1'], merknad: 'Arealplanlegging; NAF2000 Arealplanlegging med GIS (20 sp) er forgjengeren.' },
          { entryId: 'usn_naturmiljoforvaltning', emnekoder: ['NM109-1', '4112-1'], merknad: 'Arealplanlegging; 4112 Arealplanlegging og miljørett er forgjengeren og dekker også miljøretten.' },
        ],
      },
      {
        id: 'oppgave', label: 'Bacheloroppgave', kategori: 'Oppgave',
        desc: 'Det selvstendige avsluttende arbeidet i graden.',
        note: 'Omfanget spriker mye: NMBUs ECOL201 Økologisk fordypningsoppgave er på 5 sp, INN og Nord har 15 sp, UiT og UiA 20 sp og USN 30 sp (NMBA30, som erstattet 4050 på 20 sp). UiTs to oppgavekoder har få rapporterte kandidater fordi de fleste biologistudentene der går videre på master uten å levere bacheloroppgave.',
        links: [
          { entryId: 'nmbu_okologi', emnekoder: ['ECOL201-1'], merknad: 'Økologisk fordypningsoppgave, 5 sp.' },
          { entryId: 'inn_utmarksforvaltning', emnekoder: ['6EV299-1'], merknad: 'Bacheloroppgave, 15 sp.' },
          { entryId: 'nord_naturforvaltning', emnekoder: ['BAC360-1'], merknad: 'Bacheloroppgave i naturforvaltning, 15 sp.' },
          { entryId: 'usn_naturmiljoforvaltning', emnekoder: ['NMBA30-1', '4050-1'], merknad: 'Bacheloroppgave 30 sp; 4050 er 20 sp-forgjengeren.' },
          { entryId: 'uit_biologi', emnekoder: ['BIO-2203-H04', 'BIO-2201-1'], merknad: 'Bachelor\'s Thesis in Biology, 20 sp; få rapporterte kandidater.' },
          { entryId: 'uia_biologi', emnekoder: ['BIO300-1'], merknad: 'Bacheloroppgave, 20 sp.' },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    note: 'Gruppa har bare ett program, NMBUs bachelor i radioaktivitet og miljø, og det finnes derfor ingen emner å koble mot. Programmet er den eneste bachelorutdanningen i Norge innen radioaktivitet, strålevern og radioøkologi, og ingen andre institusjoner har et program som kan sammenlignes emne for emne. Programmet startet opp i 2024, og DBH har bare rapportert karakterer for ni emner, de fleste med under ti kandidater: MILJØ100 Innføring i miljøvitenskap, GEO100 Geologi, LAD102 GIS - praktisk introduksjon, PHI102 Examen philosophicum, FYS100 Fysikk og natur, MILJØ200 Forurensning og miljø, RAD200 Nukleær industri, anlegg og aktiviteter, BIO130 Generell mikrobiologi I og KJM100 Generell kjemi. Emnene deles i hovedsak med NMBUs øvrige MINA-bachelorer; bare RAD200 er spesifikt for dette programmet. Karaktertallene for programmet bør leses som en tidsserie for NMBU alene.',
    courseTypes: [
    ],
  },
  {
