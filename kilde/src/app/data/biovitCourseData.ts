// GENERERT av scripts/build-biovit-courses.py – stub. Ikke rediger for hånd.
// Tom foreløpig: generatoren skriver over hele filen når BIOVIT-emnetallene legges inn.
