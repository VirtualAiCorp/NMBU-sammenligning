...
export const LANDSAM_STUDYPLAN_GROUPS: LandsamStudyPlanGroup[] = [
  ...
  },
  {
    ...
    programs: [
      ...
      {
        entryId: 'uit_akvamedisin2', shortName: 'UiT Akvamedisin', institusjon: 'UiT Norges arktiske universitet', isNmbu: false, programnavn: 'Akvamedisin (profesjonsstudium 5 år)',
