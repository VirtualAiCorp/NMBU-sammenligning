// GENERERT av scripts/build-realtek-courses.py – stub. Ikke rediger for hånd.
// Tom foreløpig: generatoren skriver over hele filen når REALTEK-emnetallene legges inn.
