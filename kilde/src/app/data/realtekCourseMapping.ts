// GENERERT av scripts/build-realtek-course-mapping.py – stub. Ikke rediger for hånd.
// Tom foreløpig: generatoren skriver over hele filen når emnekoblingen for REALTEK er laget.
